<%@ Page Language="VB" AutoEventWireup="false" EnableTheming="true" Theme="Default"  CodeFile="Category.aspx.vb" Inherits="URLM_Category" %>
         ...
         <table style="height:100%; width:100%;" cellpadding="0" border="0" cellspacing="0"   >
           <tr>    
              <td align="left" style="border-bottom:solid 1px #000000;padding-top:4px; padding-left:1em;vertical-align:middle; background-image:url(../images/bg_CellNormal_black.jpg);background-repeat:repeat-x; width:100%;">
                  <label id="Label1" title="Notes"    style="color:White;height:100%; overflow:auto; font-weight:bold;"  >New Category</label>
              </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" > 
                  <tr>
                     ...
                     <td style="width:80%; vertical-align:top; padding-top:0px;">
                        <asp:TextBox ID="txtTitle" ValidationGroup="newCategory"  MaxLength="100" Width="220px" runat="server" SkinID="GreenSmallTextbox"></asp:TextBox>&nbsp;&nbsp;                                                                                                                          
                  ...
                  <tr>
                      ...
                      <td>
                        <asp:TextBox ID="txtDescription" ValidationGroup="newCategory"   Width="220px" Height="80px" TextMode="MultiLine" runat="server" SkinID="GreenSmallTextbox"></asp:TextBox>&nbsp;&nbsp;                                                                                                                          
                     ...
                     <tr class="UnderlinedRow">
                         <td  style="height:31px;background-color:#A0CDEE;font-size:12px;font-weight:bold;padding:5px;width:50%;">
                             <asp:UpdatePanel ID="UpdatePanel1"
                                   ...
                                   RenderMode="Inline" >
                                   <ContentTemplate>
                                     Category&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;<asp:Label runat="server" ID="lblCount" />
                                            &nbsp;<span class="NonBold">(<asp:Label runat="server" ID="lblFilter" Text="all" />)</span>&nbsp;&nbsp;<asp:Label runat="server" ID="lblError" Text="Category with this title already added." Visible="false" CssClass="ErrorMessage" ></asp:Label> 
                       ...
                       <td  colspan="2" style="height:97%;">
                            <div style="overflow:auto;height:100%;background-color:#E4F1F7;border:1px solid #ACBDD5;" id="_gridViewPanel1" class="ScrollBarHomeTicket">
                              ...
                              <asp:SqlDataSource 
                                   ...
                                   DeleteCommand="URLM_Category_Delete" DeleteCommandType="StoredProcedure"
                                   UpdateCommand="URLM_Category_Update" UpdateCommandType="StoredProcedure"
                                   InsertCommand="URLM_Category_ADD" InsertCommandType="StoredProcedure"
                                   SelectCommand="URLM_CategoryGetAllForList" SelectCommandType="StoredProcedure">
                                   <SelectParameters >  
