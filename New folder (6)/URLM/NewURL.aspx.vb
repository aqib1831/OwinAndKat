...
#Region "btnSave_Click"
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            End With
            If rtValue = 0 Then
                Response.Redirect("UrlmHome.aspx")
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            If String.IsNullOrEmpty(Request.QueryString("URLID")) = False AndAlso IsNumeric(Request.QueryString("URLID")) Then
                hdnURLID.Value = HttpContext.Current.Request.QueryString("URLID").ToString()
                lblTitle.Text = " Edit URL "
                btnSave.Text = "Update"
            Else
                lblTitle.Text = " New URL "
                btnSave.Text = "Save"
            End If
        End If
    End Sub
    ...
    Protected Sub Page_PreRenderComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRenderComplete
        If Not IsPostBack AndAlso CInt(hdnURLID.Value) <> 0 Then
            Dim objURLm As New URLM
            objURLm = URLM.GetUrlByID(CInt(hdnURLID.Value))
