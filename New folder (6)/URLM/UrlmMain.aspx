<%@ Page Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="UrlmMain.aspx.vb" Inherits="URLM_UrlmMain" title="Netsolace Portal-Url Management" %>
<%@ Register Src="~/URLM/leftpanel_Urlm.ascx" TagName="LeftPanel" TagPrefix="ucComLeftPanel" %>
