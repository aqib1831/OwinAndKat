Partial Class UM_TopicList
    ...
    End Sub
    Protected Sub gvContent_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvContent.RowCreated
    End Sub
    Protected Sub gvContent_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvContent.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Not lnkEdit Is Nothing Then
                lnkEdit.Attributes.Add("onclick", "javascript:window.location='NewTopic.aspx?TopicID=" & e.Row.DataItem("ID") & "&SelectedCategory=" & Me.ddlCategories.SelectedValue & "&SelectedType=" & Me.ddlType.SelectedValue & "&UMType=" & Request.QueryString("UMType") & "'")
            End If

            e.Row.Attributes.Add("onclick", "this.className='selectedRow';javascript:window.location='NewTopic.aspx?TopicID=" & e.Row.DataItem("ID") & "&SelectedCategory=" & Me.ddlCategories.SelectedValue & "&SelectedType=" & Me.ddlType.SelectedValue & "&UMType=" & Request.QueryString("UMType") & "'")
            If Not isWriteAccess Then
                e.Row.Cells(e.Row.Cells.Count - 1).Attributes.Add("style", "display:none")
            End If
        End If
    ...
    Protected Sub odsContent_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles odsContent.Selected
        ...
        If Not e.ReturnValue Is Nothing Then
            If IsNumeric(e.ReturnValue) = True Then
                ...
                Me.lblTopicCount.Text = e.ReturnValue.ToString()
    ...
    Protected Sub odsContent_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles odsContent.Selecting
        If flag = True Then
            e.InputParameters("CategoryID") = Me.ddlCategories.SelectedValue
        End If
    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            If String.IsNullOrEmpty(Request.QueryString("CategoryID")) = False Then
                Me.ddlType.SelectedValue = Request.QueryString("SelectedType")
            End If
        End If
        isWriteAccess = Functions.CheckSubModuleAccess(Portal.BLL.Enumeration.SubModules.UMFullAccess)
        If Not isWriteAccess Then
            ScriptManager.RegisterStartupScript(Me, Me.GetType, "hide", "document.getElementById('btnAddTopic').style.display='none';", True)
        End If
    End Sub
