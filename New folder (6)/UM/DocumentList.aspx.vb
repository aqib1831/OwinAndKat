...
Partial Class UM_DocumentList
    ...
    Protected Sub gvContent_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvContent.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Not lnkEdit Is Nothing Then
                lnkEdit.Attributes.Add("onclick", "javascript:window.location='NewDocument.aspx?DocumentID=" & e.Row.DataItem("ID") & "&SelectedCategory=" & Me.ddlCategories.SelectedValue & "&UMType=" & Request.QueryString("UMType") & "'")
            End If

            e.Row.Attributes.Add("onclick", "this.className='selectedRow';javascript:window.location='NewDocument.aspx?DocumentID=" & e.Row.DataItem("ID") & "&SelectedCategory=" & Me.ddlCategories.SelectedValue & "&UMType=" & Request.QueryString("UMType") & "';return false;")
            If Not isWriteAccess Then
                e.Row.Cells(e.Row.Cells.Count - 1).Attributes.Add("style", "display:none")
            End If
        End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not isWriteAccess Then
            ScriptManager.RegisterStartupScript(Me, Me.GetType, "hide", "document.getElementById('btnAddDocument').style.display='none';", True)
        End If
    End Sub
End Class
