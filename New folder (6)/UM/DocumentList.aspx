<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DocumentList.aspx.vb" Inherits="UM_DocumentList" StylesheetTheme="Default"   %>
            ...
            <tr class="GalleryTitle" style="background-image:url('images/bg_mainHdr_1.jpg');height:31px;">
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always"  RenderMode="Inline">
                        <ContentTemplate>
                             <b>&nbsp;Document&nbsp;-&nbsp;<asp:Label runat="server" ID="lblDocumentCount" /></b>
                            &nbsp;
                        </ContentTemplate>
                    </asp:UpdatePanel>  
                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="gvSearch" style="height:41px;">
                        <tr>
                            <td style="width:100px;">
                                <div id="divAddDocument" style="padding:3 4 5 4; width:80%;"><input type="button" value="New Document" id="btnAddDocument" class="btnSimpleSmall" style="width:120px;" onclick="AddDocument();" ></div>
                          </td>
                          <td>
                          &nbsp;
                          </td>
                                ...
                                <asp:GridView id="gvContent" DataKeyNames="ID" EnableViewState="true"  
                                    ...
                                    <Columns>
                                         ...
                                         <asp:TemplateField HeaderText="Title" SortExpression="Title">
                                            <ItemTemplate>
                                                <asp:Label ID="lblTopicTitle" runat="server" ToolTip='<%#Container.DataItem("Title") %>' Text='<%#Functions.StringTruncate(Container.DataItem("Title"),22) %>' Font-Bold="true" ForeColor="black"></asp:Label>
                                                </ItemTemplate>
                                                 <FooterTemplate>
                                                    &nbsp;
                                                </FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="File" SortExpression="FileName">
                                            <ItemTemplate>
                                                <a href='<%=ConfigurationManager.AppSettings("PortalComAttachmentPath") %><%#Container.DataItem("FileName")  %>' onclick="event.cancelBubble=true;" title='<%#Container.DataItem("FileName").Substring(Container.DataItem("FileName").LastIndexOf("/") + 1, Container.DataItem("FileName").Length - (Container.DataItem("FileName").LastIndexOf("/") + 1))%>' target="_blank" style="color:#5C7392;"><%#Functions.StringTruncate(Container.DataItem("FileName").Substring(Container.DataItem("FileName").LastIndexOf("/") + 1, Container.DataItem("FileName").Length - (Container.DataItem("FileName").LastIndexOf("/") + 1)), 17)%> </a>
                                        ...
                                        <asp:TemplateField HeaderText="Category" SortExpression="Manual">
                                            <ItemTemplate>
                                                <asp:Label ID="lblManual" runat="server" ToolTip='<%#Container.DataItem("Manual") %>' Text='<%#Functions.StringTruncate(Container.DataItem("Manual"),13) %>' Font-Bold="false" ForeColor="black"></asp:Label>
                                                </ItemTemplate>
                                                 <FooterTemplate>
                                                    &nbsp;
                                                </FooterTemplate>
