<%@ Page Language="VB" AutoEventWireup="false" EnableTheming="true" Theme="Default"
    CodeFile="Accounts.aspx.vb" Inherits="URLM_Accounts" %>
...
<body style="margin: 0; background-color: #E4F1F7; height: 100%; width: 100%">
  ...
  <div id="DivNew" runat="server" style="display: none; border: solid 1px #000000;
        position: absolute; width: 33%; height: 250px; top: 20%; left: 25%;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td style="width: 85%; vertical-align: top; padding-top: 0px;">
                                <asp:TextBox ID="txtTitle" ValidationGroup="newCategory" MaxLength="400" Width="220px"
                                    runat="server" SkinID="GreenSmallTextbox"></asp:TextBox>&nbsp;&nbsp;
                                  <asp:RequiredFieldValidator runat="server" ID="rfvAccountTitle" 
                            ControlToValidate="txtTitle"
                            ErrorMessage="<br/>Enter Title <br/>" 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDescription" ValidationGroup="newCategory" MaxLength="400" Width="220px"
                                    Height="80px" TextMode="MultiLine" runat="server" SkinID="GreenSmallTextbox"></asp:TextBox>&nbsp;&nbsp;
                              <asp:RequiredFieldValidator runat="server" ID="rfvAccountDescription" ControlToValidate="txtDescription"
                                    ErrorMessage="<br/> Enter Description <br/>" Display="Dynamic" CssClass="ErrorMessage" ValidationGroup="newCategory">
                                </asp:RequiredFieldValidator>
                        ...
                        <tr>
                            ...
                            <td style="width: 85%; vertical-align: top; padding-top: 0px;">
                                <asp:TextBox ID="txtPwdHint" ValidationGroup="newCategory" MaxLength="100" Width="220px"
                                    runat="server" SkinID="GreenSmallTextbox"></asp:TextBox>&nbsp;&nbsp;
                            </td>
                        </tr>
                        <tr>
        ...
        <tr class="UnderlinedRow">
            <td style="height: 31px; background-color: #A0CDEE; font-size: 12px; font-weight: bold;
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                    <ContentTemplate>
                        Accounts&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;<asp:Label runat="server" ID="lblCount" />
                        &nbsp;<span class="NonBold">(<asp:Label runat="server" ID="lblFilter" Text="All" />)</span>&nbsp;&nbsp;<asp:Label
                            runat="server" ID="lblError" Text="Account with this title already added." Visible="false"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr class="UnderlinedRow">
                                    <td style="padding-left: 3px; width: 130px; padding-bottom: 3px; text-align: center;
                                        padding-top: 11px;">
                                        <asp:LinkButton ID="lnkAddNew" OnClientClick="showNewAccount();  return false;" runat="server"
                                            CssClass="HomeButton">
            ...
            <td colspan="2" style="height: 97%;">
                <div style="overflow: auto; height: 100%; background-color: #E4F1F7; border: 1px solid #ACBDD5;"
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvAccounts" runat="server" SkinID="GridViewNormal" DataSourceID="sdsAccounts"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Title" SortExpression="DataText">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtTitle" SkinID="GreenSmallTextbox" runat="server" MaxLength="400"
                                    ...
                                    <asp:TemplateField HeaderText="Password Hint" SortExpression="PasswordHint">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPasswordHint" SkinID="GreenSmallTextbox" MaxLength="100" Width="90%"
                                                runat="server" Text='<%# Bind("PasswordHint") %>'></asp:TextBox>
                                            <br />
                                            <br />
                                        </EditItemTemplate>
                    ...
                    <asp:SqlDataSource ID="sdsAccounts" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
                        DeleteCommand="SSLM_Accounts_Delete" DeleteCommandType="StoredProcedure" UpdateCommand="SSLM_Accounts_Update"
                        UpdateCommandType="StoredProcedure" InsertCommand="SSLM_Accounts_Add" InsertCommandType="StoredProcedure"
                        SelectCommand="SSLM_AccountsGetAllForList" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                        ...
                        <InsertParameters>
                            ...
                            <asp:ControlParameter ControlID="hdnDescription" Name="Description" PropertyName="Value"
                                Type="String" />
                            <asp:ControlParameter ControlID="hdnPwdHint" Name="PasswordHint" PropertyName="Value"
                                Type="String" />
