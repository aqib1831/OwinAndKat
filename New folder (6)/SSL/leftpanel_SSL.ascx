<%@ Control Language="VB" AutoEventWireup="false" CodeFile="leftpanel_SSL.ascx.vb" Inherits="contacts_leftpanel_PM"  %>
           ...
           <div id="divToolTip" style="background:#D8EAFC;border:1px solid black;display:none;position:absolute;width:300px;z-Index:1000;font-size:12px; font-weight:normal; padding:2px; padding-left:3px;"></div>            
                    <asp:Repeater
                        ...
                        <FooterTemplate>
                                                ...
                                                <tr id="trStores_NoRecord" style="height:25px;text-align:center;" runat="server" ><td colspan="3" style="font-style:italic;text-align:center;height:20px;">No SSL to show!</td></tr>
   ...
   function ChangeTrBackGround(type)
    ...
    function RedirectEditURLPage(ID)
        {      
         ...
         Iframe.location = 'NewSSL.aspx?SSLID='+ ID;
