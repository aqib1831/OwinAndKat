						   <%@ Page Language="VB" ValidateRequest="false" AutoEventWireup="false" CodeFile="SSLHome.aspx.vb" Inherits="EA_SSL_Default" Theme="Default"  %>
             ...
             <tr class="UnderlinedRow">
                 <td  style="height:20px;background-color:#A0CDEE;font-size:12px;font-weight:bold;padding:5px;width:35%;">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                       <ContentTemplate>
                         SSLs &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;<asp:Label runat="server" ID="lblActivityCount" />
                ...
                <td style="background-color:#A0CDEE;font-size:12px;font-weight:bold;padding:3px;color:#437494;text-align:right;cursor:pointer; height: 1px;width:150px;">
                 ...
                 <td style="background-color:#A0CDEE;font-size:12px;font-weight:bold;padding:3px;color:#437494;text-align:right;cursor:pointer; height: 1px;width:115px;">
                    <img align="absMiddle"  height="20" src="../images/pixel_skyBlue.jpg" width="1" alt="" /><img align="absMiddle"  height="20" src="../images/pixel_skyBlue.JPG" width="1"  alt=""/>
                     &nbsp;                   
                     <asp:LinkButton ID="imgNewURL" OnClientClick="javascript:window.location='NewSSL.aspx'; return false;" runat="server" CssClass="HomeButton">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" class="tableSubHead" >
                             <tr style="height:25px;"  >
                                <td align="left"  valign="middle" style="padding-right:1px;display:none;"  >
                                   &nbsp;
                                  <asp:ImageButton ID="btnDeleteSelected" style="vertical-align:middle" runat="server" ToolTip="Delete All Selected SSLs" CausesValidation="false" Visible="false" OnClientClick="return isReadyDelete();" ImageURL="../images/ico_deleteAll.gif" />
                                  </td>
                                    <td align="left" valign="middle" style="padding-top:2px; display:none;">
                                      <asp:ImageButton ID="btnUpdateAllURLs" Visible="false" style="vertical-align:middle" runat="server" ToolTip="Update All Selected SSLs" CausesValidation="false"  OnClientClick="return isAnyCheckboxSelected();" ImageURL="../images/ico_updateAll.gif" />            
                                    </td>                               
                                ...
                                <td align="left" valign="middle" style="padding-top:2px; padding-bottom:2px; width:220px;" >
                         ...
                         <asp:GridView id="grdURLs" runat="server"
                             ...
                             AllowSorting="True" > 
                              <PagerSettings Mode="Numeric" Position="Bottom"  />
                                ...
                                <asp:TemplateField SortExpression="URL" HeaderText="&nbsp;SSL">                                                        
                                ...
                                <ItemStyle Height="15px" Width="30px" CssClass="NoSideBorder" />
                                     <ItemTemplate >                                       
                                       <a id="btnEdit"  onclick="javascript:window.location='NewSSL.aspx?SSLID=<%# Container.DataItem("UrlID") %>'; return false;"  title="Edit URL" >Edit</a>
                                    </ItemTemplate>
                                </asp:TemplateField>                             
                            </Columns>                                      
                         </asp:GridView> 
                 ...
                 <table cellspacing="0" cellpadding="0" width="100%" border="0">                                             
                    <tr>  
                       <td align="left" style="border-bottom:solid 1px #000000; padding-left:1em; background-image:url(../images/bg_CellNormal_black.jpg);background-repeat:repeat-x; width:100%;">
                            <strong><asp:Label runat="server" Font-Size="14px" ID="Label1" Text="Add New SSL" ForeColor="white"></asp:Label> </strong>
                       </td>
                            ...
                            <table cellspacing="4" cellpadding="1" width="80%" align="center" border="0">                                    
                                    <tr>
                                        <td style="FONT-WEIGHT: bold; FONT-SIZE: 12px; COLOR: red" valign="top" width="25%" colspan="3">
                                            Please enter one SSL in one line.</td></tr><tr><td style="COLOR: red" valign="top"></td>
                                        <td valign="top"></td><td style="WIDTH: 190px" valign="top">
                                             <asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" ControlToValidate="txtURLs" ValidationGroup="UpdateURLs" ErrorMessage="Please enter at least one SSL." Display="Dynamic"></asp:RequiredFieldValidator></td>
                                    </tr>
                                    <tr>
                                        <td style="COLOR:red;FONT-SIZE:10px;" valign="top">*</td><td valign="top" style="FONT-SIZE: 12px;">SSLs. </td>
               ...
               <td>
                 <table cellspacing="0" cellpadding="0" width="100%" border="0">
                         <tr>  
                           <td align="left" style="border-bottom:solid 1px #000000; padding-left:1em; background-image:url(../images/bg_CellNormal_black.jpg);background-repeat:repeat-x; width:100%;">
                            <strong>
                                <asp:Label runat="server" Font-Size="14px" ID="lblHeadertext" Text="Add New SSL" ForeColor="white"></asp:Label> 
                            </strong>
                          </td>
                                ...
                                <table cellspacing="4" cellpadding="1" width="100%" align="center" border="0">
                                       <tr>                                                                
                                            ...
                                            <td style="WIDTH: 75%;" valign="top">
                                                ...
                                                <asp:RequiredFieldValidator id="RequiredFieldValidator2" CssClass="ErrorMessage" runat="server" ControlToValidate="txtURL" ValidationGroup="NewURL" ErrorMessage="Enter SSL." Display="Dynamic">
                                                 </asp:RequiredFieldValidator>
                                                 <asp:RegularExpressionValidator ID="regUrl" runat="server" ValidationGroup="NewURL" CssClass="ErrorMessage" ControlToValidate="txtURL" Display="Dynamic" ErrorMessage="Enter valid SSL." ValidationExpression="([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?"></asp:RegularExpressionValidator>
                                            </td>
                                       </tr>
                                       <tr>                                                                
                                     ...
                                     <tr>                                                            
                                        <td valign="top" class="SimpleLabel">Referral SSL: </td>
                                        <td  valign="top">
