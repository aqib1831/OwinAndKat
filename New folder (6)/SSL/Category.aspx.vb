Partial Class URLM_Category
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        If Page.IsValid Then
            ...
            Result = SSLM.CheckDuplicateCategoryByTitle(txtTitle.Text)
            If Result > 0 Then
                lblErrorMsg.Visible = True
                lblErrorMsg.Text = "Category already exsits."
            ...
            Else
                Dim abc As Integer = sdsCategories.Insert()
                DivNew.Attributes.Add("style", "display:none;")
    ...
    Protected Sub val_server_duplicate_Category_check_Grid_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs)
        ...
        If Title <> "" Then
            ...
            Result = SSLM.CheckDuplicateCategory(ID, Title)
            If Result > 0 Then
