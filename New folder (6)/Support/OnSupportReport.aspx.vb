...
Partial Class Support_OnSupportReport
    ...
    Public Sub showClientOrState()
        If (CInt(Request.QueryString("ddlOnSupport")) = 0) Then
            divOnSupport.InnerText = "Support Franchises"
        ElseIf (CInt(Request.QueryString("ddlOnSupport")) = 1) Then
            divOnSupport.InnerText = "On Support Franchises"
        Else
            divOnSupport.InnerText = "Not On Support Franchises"
        End If
    ...
    Protected Sub rptReport_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptReport.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            ...
            If CInt(Request.QueryString("ddlClient")) > 0 Then
                Dim tdClient As HtmlTableCell = CType(e.Item.FindControl("tdClientCode"), HtmlTableCell)
                tdClient.Visible = False
            End If
            If CInt(Request.QueryString("ddlOnSupport")) > 0 Then
                Dim tdOnSupport As HtmlTableCell = CType(e.Item.FindControl("tdOnSupport"), HtmlTableCell)
                tdOnSupport.Visible = False
            End If
        End If
