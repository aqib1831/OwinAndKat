<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OnSupportReport.aspx.vb" Inherits="Support_OnSupportReport"  %>
                ...
                <td  align="center">
                    ...
                    <tr>
                        <td align="center" style="height:50px;">
                            ...
                            <div id="divOnSupport" runat="server" style="width:100%; text-align:center;" class="ReportName">Support Franchises</div>
                            ...
                            <td style="background-color:#FFFFFF;border:0;" valign="top" id="td1" >
                                ...
                                <HeaderTemplate>
                                    <table style="margin: 0px; border: 0px;" cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr style="height:30px;" class="HeaderRow" >
                                            ...
                                            <td align="left" style="width:11%;" class="TableHeading" id="tdOnSupport" runat="server" >
                                               On Support
                                            </td>   
                                ...
                                <ItemTemplate>
                                         <tr style="height:25px; ">
                                            ...
                                            <td class="ItemRow" id="tdOnSupport" runat="server">
                                                 <%#IIf(Eval("OnSupport") = True andalso Eval("SupportEnddate") > date.Now,"True","False" )%>  
                                                &nbsp;
                                            </td>
                                            <td class="ItemRow">
                               ...
                               <asp:ObjectDataSource ID="odsSupport" runat="server"    
                                   ...
                                   <SelectParameters>
                                        ...
                                        <asp:QueryStringParameter QueryStringField="ddlOnSupport" Name="OnSupport" Type="Int32" />
                                        <asp:Parameter Name="sortBy" Type="String" DefaultValue="" ConvertEmptyStringToNull="false" />     
