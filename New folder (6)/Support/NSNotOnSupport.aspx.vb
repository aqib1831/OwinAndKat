...
Partial Class Support_NSNotOnSupport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ClientScript.RegisterStartupScript(Me.GetType, "SelectTab", "parent.SetSelected(2);", True)
            If (Request.QueryString("From") <> Nothing AndAlso Request.QueryString("From").ToLower = "helpdesk") Then
                If (Request.QueryString("ID") <> Nothing AndAlso IsNumeric(Request.QueryString("ID"))) Then
                    ...
                    If ID = 0 AndAlso OnSupport = False Then
                        ScriptManager.RegisterStartupScript(Me, Me.GetType, "signup", "signup('" & FranchiseID & "','" & ProductID & "','" & ClientID & "');", True)
                    ...
                    ElseIf OnSupport AndAlso ID > 0 Then
                        ScriptManager.RegisterStartupScript(Me, Me.GetType, "ExtendSupport", "ExtendSupport('" & FranchiseID & "','" & ProductID & "','" & ClientID & "','" & ID & "');", True)
                ...
                End If
            End If
            'ScriptManager.RegisterStartupScript(Me, Me.GetType, "ExtendSupport", "ExtendSupport('" & 2 & "','" & 159 & "','" & 1 & "','" & 29 & "');", True)
            'ClientScript.RegisterStartupScript(Me.GetType, "SelectTab", "ExtendSupport('" & 2 & "','" & 159 & "','" & 1 & "','" & 29 & "');", True)
        End If
    End Sub
    ...
    Protected Sub odsSupport_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles odsSupport.Selected
        If (IsNumeric(e.ReturnValue)) Then
            ...
            ScriptManager.RegisterStartupScript(Me, Me.GetType(), "showcount", "parent.showNosupportcount(" & e.ReturnValue.ToString() & ");", True)
