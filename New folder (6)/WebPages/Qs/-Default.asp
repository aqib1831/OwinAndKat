        ...
        <td height="30" valign="middle"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="35" align="center" class="hLinkWhite"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="173"><img src="images/btn_viewUserG.jpg" width="173" height="34" style="cursor:pointer" onClick="scrIframe.location='https://qa.netsolace.com/portal/um/client/UMClientMain.aspx?CategoryID=2944.15KlSmJsYws'; document.getElementById('divGuide').style.display='inline';" /></td>
