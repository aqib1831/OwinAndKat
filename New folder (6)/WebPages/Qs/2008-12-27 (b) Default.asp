...
{	
	...
	var ID = scrIframe.GetDiv();
	var div = window.frames.scrIframe.iframeMain.MainDiv
	if (div.clientHeight < div.scrollHeight)
			{
			document.getElementById('imgUp').src = "images/up_normal.png";
...
<div id="divGuide" class="div_border" style=" position:absolute; top:0px; left:0px; width:675px; height:715px; background:#D0DECF; overflow:hidden; display:none;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
	...
	<tr>
	  <td height="80" width="60%" align="right">
		  ...
		  <td height="80" align="right">
		            <input type="image" id="imgUp" src="images/up_normal.png" onMouseDown="this.src='images/up_pressed.png'; blnScroll = true;Scroll('window.frames.scrIframe.iframeMain.MainDiv',-4);" onMouseUp="this.src='images/up_normal.png'; blnScroll = false; ScrollEnd();"  onClick="return false;" />
					<input name="image" type="image" id="imgDown" onMouseDown="this.src='images/down_pressed.png'; blnScroll = true;Scroll('window.frames.scrIframe.iframeMain.MainDiv',4);" onMouseUp="this.src='images/down_normal.png'; blnScroll = false; ScrollEnd();" onClick="return false;"  src="images/down_normal.png" />&nbsp;&nbsp;
