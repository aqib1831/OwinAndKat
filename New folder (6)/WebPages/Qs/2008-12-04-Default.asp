      ...
      <td align="center" valign="top">
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="div_bgWhite" height="100%">
          <tr>
            <td>
              <div style="width:99%;height:100%;overflow:auto">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="Center" height="100%">
                  ...
                  <tr>
                    <td >
                      <table width="100%" border="0" height="100%" style="font-size:12px;">
                        <tr>
                    ...
                    <tr>
                      <td><blockquote>
                        <p>All Qs related news is posted in the middle section of the home page screen, which is updated by corporate office.</p>
                      </blockquote></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td><blockquote>
                        <p>The Quickserve (Qs) software navigation bar is located on the right side of the home page and acts as an access point for all necessary functions.</p>
                      </blockquote></td>
                    </tr>
                  ...
                  <tr>
                    <td >
                      <table width="100%" border="0" height="100%" style="font-size:12px;">
                        ...
                        <tr>
                          <td><blockquote>
                            <p>Tap the <strong>Clock In</strong> button to bring up the clock-in screen. Swipe the Employee card or enter the Employee Pin to clock-in to Qs.</p>
                          </blockquote></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td><blockquote>
                            <p>Tap the <strong>Clock Out</strong> button to bring up the clock-out screen. Swipe the Employee card or enter the Employee Pin to clock-out of Qs.</p>
                          </blockquote></td>
                        </tr>
                    </table>
                    </td>
                  ...
                  <tr>
                    <td >
                      ...
                      <tr>
                        <td><blockquote>
                          <p>1. Select merchandise in the <strong>Category (1)</strong> section.</p>
                        </blockquote></td>
                      </tr>
                      <tr>
                        <td><blockquote>
                      ...
                      <tr>
                        <td><blockquote>
                          <p>3. Select product from the <strong>Product (3)</strong> section.</p>
                        </blockquote></td>
                      </tr>
                      <tr>
                        <td><blockquote>
                      ...
                      <tr>
                        <td><ul>
                          <li>Select Product within Receipt section and click <strong>Quantity</strong> button to activate pad to edit product quantity. Select number to reflect total quantity of same product.</li>
                        </ul></td>
                      </tr>
                      <tr>
                        <td><ul>
                      ...
                      <tr>
                        <td><blockquote>
                          <p>Note: On a large order, the desired product to remove may be found by using the <strong>Up</strong> and <strong>Down</strong> keys situated at the bottom of receipt section.</p>
                        </blockquote></td>
                      </tr>
                      <tr>
                        <td><ul>
                          <li>Select product to be removed from Receipt section by utilizing the Up and Down keys.</li>
                        </ul></td>
                      </tr>
                      <tr>
                        <td><ul>
                          <li>Click <strong>Remove</strong> button to remove selected product from the order.</li>
                        </ul></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Press the <strong>comp</strong> button before selecting any category.</td>
                      </tr>
                      <tr>
                  ...
                  <tr>
                    <td >
                      ...
                      <tr>
                        <td><blockquote>
                          <p><strong>Exact Amount:</strong> If customer provides with the exact amount, select <strong>Exact Amount</strong> button and the transaction will process automatically.</p>
                        </blockquote></td>
                      </tr>
                      <tr>
                        <td><blockquote>
                          <p><strong>Quick Amount Buttons:</strong> Below the exact amount button, there are buttons that allow you to enter the most likely amounts the customer might give. The <strong>Amount Tendered</strong> and <strong>Change Due</strong> amounts will be displayed. Click <strong>OK</strong> to process payment.</p>
                        </blockquote></td>
                      </tr>
                      <tr>
                        <td><blockquote>
                          <p>Pad: If the above methods cannot be used for what the customer provides, click the &ldquo;Pad&rdquo; button to open a number pad. Enter the amount tendered and click OK. The Amount Tendered and Change Due amounts will be displayed. Click OK to process payment.</p>
                        </blockquote></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td><ul>
                          <li>Swipe the credit card to automatically enter all credit card information into the process screen. Click <strong>Process</strong> to process payment.</li>
                        </ul></td>
                      </tr>
                      <tr>
                        <td><ul>
                          <li>Card approval notification will display onscreen and a receipt will print for signatures and one for customer to keep.</li>
                        </ul></td>
                      </tr>
                      <tr>
                        <td><blockquote>
            ...
            <tr>
              <td><ul>
                <li>Tap on <strong>View</strong> to see transaction details and click <strong>Print</strong> to re-print receipt.</li>
              </ul></td>
            </tr>
            <tr>
              <td><ul>
                <li>Number Pad on the same screen provides the ability to search orders by order number.</li>
              </ul></td>
            </tr>
            <tr>
