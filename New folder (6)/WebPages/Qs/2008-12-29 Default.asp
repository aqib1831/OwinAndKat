    ...
    <tr>
      <td align="center" valign="top" colspan="3">
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="div_bgWhite" height="578" width="100%">
          <tr>
            <td><iframe id="scrIframe" src="https://qa.netsolace.com/portal/um/client/UMClientMainStatic.aspx?CategoryID=2944.15KlSmJsYws" marginheight="0" marginwidth="0" scrolling="auto" height="100%" width="100%"></iframe></td>
          </tr>
        </table>
      </td>
    </tr>
	<tr>
	  ...
	  <td height="80" width="40%" align="center">
		  ...
		  <td height="80" width="30%" align="right">
					...
					<input type="image" id="imgUp2" src="images/up_disabled.png"  style="display:none;" />
					<input name="image" type="image" id="imgDown2" src="images/down_disabled.png" style="display:none;" />&nbsp;&nbsp;
