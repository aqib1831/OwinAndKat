...
<div id="divGuide" class="div_border" style=" position:absolute; top:0px; left:0px; width:675px; height:715px; background:#D0DECF; overflow:hidden; display:none">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
    <tr>
      <td height="57"><img src="images/header_userGuide.jpg" width="667" height="57" border="0" usemap="#Map" /></td>
    </tr>
    <tr>
      <td align="center" valign="top">
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="div_bgWhite" height="100%" width="100%">
          <tr>
            <td>
              <iframe frameborder="0" marginheight="0" marginwidth="0" scrolling="auto" height="100%" width="100%" src="https://qa.netsolace.com/portal/um/client/UMClientMain.aspx?CategoryID=2944.15KlSmJsYws"></iframe>
            </td>
          </tr>
        </table>
      </td>
