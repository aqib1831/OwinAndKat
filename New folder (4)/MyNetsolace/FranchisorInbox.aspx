             ...
             <tr>
                <td colspan="2" style="height:40px;background-color:#BADCFC;font-size:11px;">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="white-space:nowrap;">
                    <tr>                  
                      <td align="left" style="padding-left:5px; padding-right:5px;width:10%; ">
                        <span style="font-size: 7pt; color: #7c8798">Filters</span><br />
                          ...
                          <td style="padding:5px; white-space:nowrap; width:20%;" align="left"   >
                         ...
                         <asp:GridView 
                            ...
                            DataSourceID="sdsInbox" > 
                             ...
                             <Columns>                                                              
                                    ...
                                    <asp:TemplateField ItemStyle-Width="7%" HeaderText="Ticket #"  SortExpression="Ticket" ItemStyle-Wrap="false"  >
                                    <ItemTemplate >
                                    ...
                                    <ItemTemplate >
                                        <asp:Label runat="server" ID="lblFranchise" ToolTip='<%# Eval("StoreNick")%>' Text='<%# Functions.StringTruncate(Eval("StoreNick"), 18) %>' ></asp:Label>                                        
                                    </ItemTemplate>
                                    </asp:TemplateField>
                                     ...
                                     <asp:TemplateField ItemStyle-Width="22%" HeaderText="Subject" SortExpression="Subject" >
                                        <ItemTemplate >
