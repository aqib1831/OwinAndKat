                 ...
                 <table width="100%" style="height: 20px; margin: 0px; padding: 0px; background-color: #E4F1F7;"
                     ...
                     <tr>
                             ...
                             <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                 <ContentTemplate>
                                     <pre style="height: 20px; font-family: Arial; font-size: 12px; font-weight: bold;
                                         padding: 3px; float: left;">My Tickets  |  <asp:Label runat="server" ID="lblErrorCount" />&nbsp;(<asp:Label
                         ...
                         <td style="background-color: #A0CDEE; padding: 3px; text-align: right; width: 60%;">
                                 <div style="width: 80px;" class="LeadDetailButton" onclick="printReport(1)">
                                     Print
                                     <img id="Img2" src="../../images/blt_resetFilters.gif" align="absmiddle"
