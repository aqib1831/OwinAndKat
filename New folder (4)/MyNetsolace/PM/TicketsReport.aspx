   ...
   <div style="height:100%; width:100;">
    ...
    <asp:HiddenField ID="hdnTimeSpent" runat="server" Value="00:00:00" EnableViewState="False" />
        <table  cellpadding="0" cellspacing="0" style="height:100%; width:650; text-align:left; border:5px double #EFEFEF; font-size:10pt;">
            ...
            <tr>
                <td align="left" style="background-color: #ebebeb; padding-left: 10px; padding-top: 5px;">
                    <asp:Label ID="lblTicketColumnName" runat="server" EnableViewState="False"></asp:Label>
                    </td>
                <td align="left" style="padding-left: 10px; padding-top: 5px; background-color: #ebebeb">
                    <asp:Label ID="lblTicketNo" runat="server" EnableViewState="False" Font-Bold="True"></asp:Label></td>
                <td align="left" style="padding-left: 10px; padding-top: 5px; background-color: #ebebeb">
                    Type:
                </td>
                <td align="left" colspan="2" style="background-color: #ebebeb; padding-top: 5px;">
                    <asp:Label ID="lblType" runat="server" Font-Bold="True" EnableViewState="False"></asp:Label></td>
            </tr>
            <tr>
                <td align="left" style="background-color: #ebebeb; padding-left: 10px;" colspan="2">
                    <asp:Label ID="lblTicketName" runat="server" Font-Bold="True" EnableViewState="False"></asp:Label></td>
                <td align="left" style="padding-left: 10px; background-color: #ebebeb">
                     Priority:
                </td>
                <td align="left" style="background-color: #ebebeb;" colspan="2">
                     <asp:Label ID="lblPriority" runat="server" Font-Bold="True" EnableViewState="False"></asp:Label></td>
            </tr>
            <tr>
                <td align="left" style="background-color: #ebebeb; padding-left: 10px;">
                    Client:</td>
                <td align="left" style="padding-left: 10px; background-color: #ebebeb">
            ...
            <tr>
                ...
                <td align="left" style="padding-left: 10px; background-color: #ebebeb">
                    Date Created:</td>
                <td align="left" colspan="2" style="background-color: #ebebeb;">
            ...
            <tr id="trrelease" runat="server">
                ...
                <td align="left" colspan="2" style="padding-left: 10px; background-color: #ebebeb">
                     <asp:Label ID="lblReleaseName" runat="server" Font-Bold="True" EnableViewState="False"></asp:Label></td>
                <td align="left" style="padding-left: 10px; background-color: #ebebeb">
                   </td>
                <td align="left" style="background-color: #ebebeb">
               
                </td>
            </tr>
            <tr visible="false" runat="server" >
                <td align="left" style="padding-left: 10px; padding-bottom: 5px; background-color: #ebebeb">
                    Total Time (HH:MM):</td>
                <td align="left" style="padding-left: 10px; padding-bottom: 5px; background-color: #ebebeb">
                ...
                <td align="left" colspan="2" style="padding-bottom: 5px; background-color: #ebebeb">
                </td>
            </tr>
            <tr>
                <td align="left">
