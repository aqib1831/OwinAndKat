 ...
 <table style="width:<%=IIF(Request.queryString("Type")=1,"670px","100%") %>" height="100%" cellpadding ="0" cellspacing="0" border ="0" align="center">
                    ...
                    <table style="height: 100%; width: 100%;" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            <td align="center" style="height:20px;">
                                <div style="width: 100%; text-align: center;" class="Filters">
                                    Category:
                                    <%=IIf(Request.QueryString("categoryID").Trim() = 0, "Show All", Request.QueryString("categoryTitle"))%>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" style="height:20px;">
                                <div style="width: 100%; text-align: center;" class="Filters">
                                    Filter :
                                    <%=IIf(Request.QueryString("filterID").Trim() = 0, "Show All", Request.QueryString("filterTitle"))%>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <table style="margin: 0px; border: 0px; width: 100%;" cellpadding="0" cellspacing="0" border="0">
                                    <asp:Repeater ID="rptMyNetsolace" runat="server" EnableTheming="true" EnableViewState="true" DataSourceID="OdsPM">
                                        <HeaderTemplate>
    ...
    <asp:ObjectDataSource ID="OdsPM" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:QueryStringParameter QueryStringField="categoryID" DefaultValue="1" Name="CategoryID"
                 Type="Int32" />
                 <asp:Parameter Name="startRowIndex" Type="int32" DefaultValue="0" />
                 <asp:Parameter Name="maximumRows" Type="int32" DefaultValue="100000000" />
            <asp:QueryStringParameter QueryStringField="filterId" DefaultValue="0" Name="FilterID"
                Type="Int32" />
            <asp:QueryStringParameter Name="sortExpression" QueryStringField="sortExpression" Type="String" />
            <asp:QueryStringParameter QueryStringField="search" DefaultValue="" Name="txtsearch" 
                Type="String" />
        </SelectParameters>
