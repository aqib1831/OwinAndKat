...
<script type="text/javascript" language="javascript" >
	...
	function RedirectPage2(pageId) {
		...
		switch (pageId) {
			case 1:
				iframeMain.location = '../../MyNetsolace/ClientContact/ClientContactUser.aspx';
				document.getElementById('<%= tr1.ClientID %>').className = "leftPanel_Selected";
				break;
			case 2:
				iframeMain.location = '../../MyNetsolace/ClientContact/ClientContactNewUser.aspx';
				document.getElementById('<%= tr2.ClientID %>').className = "leftPanel_Selected";
				break;
			default:
				iframeMain.location = '../../MyNetsolace/ClientContact/ClientContactUser.aspx?PrevPage=MyNetsolace&ddlClient=' + hdnClientID;
				document.getElementById('<%= tr1.ClientID %>').className = "leftPanel_Selected";
				break;
		}
	}
