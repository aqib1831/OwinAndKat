                            ...
                            <td colspan="3">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TopBar3DTable">
                                    <tr>
                                        ...
                                        <td style="width:160px;text-align:left;font-size:18px;color:#383C3C;white-space:nowrap;">&nbsp;MyNetsolace Login</td>
                                        <td >&nbsp;</td>
                                                        ...
                                                        <td>
                                                            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;height:100%;background-color:#DDEEFE;font-size:12px;color:#73797F;">
                                                                <tr><td colspan="2"></td></tr>
                                                                 <tr>
                                                                    <td style="height:25px;padding-left:1em;white-space:nowrap;">Company Code:</td>
                                                                    <td style="text-align:right;">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtClientCode" Display="None"  ErrorMessage=""></asp:RequiredFieldValidator>
                                                                   </td>
                                                                 </tr>
                                                                <tr>
                                                                    <td style="height:25px;padding-left:1em;">Username:</td>
                                                                    <td style="text-align:right;">
                                                                        <asp:TextBox ID="txtUserName" runat="server"  MaxLength="50" CssClass="TextBoxBlueBorder" Text="" TabIndex="2"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUserName" Display="None"  ErrorMessage=""></asp:RequiredFieldValidator>
                                                                   </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="height:25px;padding-left:1em;">Password:</td>
                                                                    <td style="text-align:right;">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RFV_lblKey" runat="server" ControlToValidate="txtPassword" Display="None"  ErrorMessage=""></asp:RequiredFieldValidator>
                                                                   </td>
                                                                </tr>
                                                                <%--<tr>
