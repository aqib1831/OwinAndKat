...
Partial Class PM_TicketsDetail
            ...
            If String.IsNullOrEmpty(Request.QueryString("ID")) = False AndAlso IsNumeric(Request.QueryString("ID")) Then
                ...
                If String.IsNullOrEmpty(Request.QueryString("PrevPage")) = False AndAlso IsNumeric(Request.QueryString("PrevPage")) Then
                    ...
                    Select Case PrevPage.Value
                        ...
                        Case 2 'Feature
                            btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/MyNetsolace/PM/Features.aspx?ID=" & hdnReleaseID.Value) & "&ddlClients=" & Session("MyNetsolace_ClientID") & "&ddlCategories=" & ddlCategories & "&ddlTypes=" & ddlTypes & "&ddlFilter=" & ddlFilter & "&txtSearch=" & txtSearch & "&reClients=" & reClient & "&reCategories=" & reCatagory & "'; return false; ")
                        Case 3 'Tickets
                            btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/MyNetsolace/PM/Tickets.aspx?ddlClients=" & ddlClients) & "&ddlCategories=" & ddlCategories & "&ddlTypes=" & ddlTypes & "&ddlFilter=" & ddlFilter & "&txtSearch=" & txtSearch & "'; return false; ")
                        ...
                        Case 4 'MyTickets
                            btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/MyNetsolace/PM/MyTickets.aspx?ddlClients=" & ddlClients) & "&ddlCategories=" & ddlCategories & "&ddlFilter=" & ddlFilter & "&txtSearch=" & txtSearch & "'; return false; ")
                        ...
                        Case 5 'Tickets History
                            btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/MyNetsolace/PM/TicketsHistory.aspx?ddlClients=" & ddlClients) & "&ddlCategories=" & ddlCategories & "&ddlTypes=" & ddlTypes & "&ddlFilter=" & ddlFilter & "&txtSearch=" & txtSearch & "'; return false; ")
                        Case Else
    ...
    Protected Sub btnUpdateUsers_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdateUsers.Click
        If (Session("update").ToString() = ViewState("update").ToString()) Then
            ...
            For i = 0 To rptClientContacts.Items.Count - 1
                Dim chkBox As CheckBox = CType(rptClientContacts.Items(i).FindControl("chkClientContacts"), CheckBox)
    ...
    Protected Sub rptClientContacts_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptClientContacts.ItemDataBound
        ...
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            Dim chkbox As CheckBox = CType(e.Item.FindControl("chkClientContacts"), CheckBox)
