            ...
            If ActivityID > 0 Then
                ...
                With objActivityAttachement
                    ...
                    Select Case PreviousPage
                        Case 2
                            Response.Redirect("FranchiseeInbox.aspx?FranchiseID=" & hdnFranchiseID.Value & "&ClientID=" & hdnClientID.Value)
                            Exit Select
                        Case 3
                            Response.Redirect("FranchisorInbox.aspx?ClientID=" & hdnClientID.Value)
                            Exit Select
                        Case 4
                            Response.Redirect("FranchiseeHistory.aspx?ClientID=" & hdnClientID.Value & "&FranchiseID=" & hdnFranchiseID.Value)
                            Exit Select
                        Case 5
                            Response.Redirect("FranchisorInbox.aspx?ClientID=" & hdnClientID.Value)
                            Exit Select
                        Case 6
                            Response.Redirect("AreaDeveloperInbox.aspx?ClientID=" & hdnClientID.Value)
                            Exit Select
                        Case Else
                            Response.Redirect("ActivityDetail.aspx?FranchiseID=" & hdnFranchiseID.Value & "&ClientID=" & hdnClientID.Value)
                            Exit Select
                    End Select
                End With
            End If
