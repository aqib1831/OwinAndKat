...
Partial Class MyNetsolace_ClientContactUser
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ScriptManager.RegisterStartupScript(Me, Me.GetType, "FixPager", "FixPager();", True)
    ...
    Protected Sub gvUsers_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvUsers.RowCommand
        If e.CommandName <> "Sort" AndAlso e.CommandName <> "Page" Then
    ...
    Protected Sub gvUsers_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvUsers.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(0).Attributes.Add("onclick", "ShowUserDetail(" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & ");")
            e.Row.Cells(1).Attributes.Add("onclick", "ShowUserDetail(" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & ");")
            e.Row.Cells(2).Attributes.Add("onclick", "ShowUserDetail(" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & ");")
            e.Row.Cells(3).Attributes.Add("onclick", "ShowUserDetail(" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & ");")
