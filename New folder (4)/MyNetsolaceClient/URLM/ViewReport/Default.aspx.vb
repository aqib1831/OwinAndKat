...
Partial Class _Default2
    ...
    Private ReportType As Portal.BLL.Enumeration.ReporType
...
#End Region
    ...
    Private Sub ConfigureReportSettings()
        ...
        ReportType = CType(Request("ReportType"), Portal.BLL.Enumeration.ReporType)
        ...
        If ReportType = Portal.BLL.Enumeration.ReporType.Url_List Then
            ds = LoadURLs()
        ElseIf ReportType = Portal.BLL.Enumeration.ReporType.Support_Billing_Details Then
            ds = LoadSupportBillingDetailsData()
        ElseIf ReportType = Portal.BLL.Enumeration.ReporType.Support_Billing Then
            ds = LoadSupportBillingData()
        ElseIf ReportType = Portal.BLL.Enumeration.ReporType.Support_Checklist Then
...
#Region "Load data for Reports"
    ...
    Private Function LoadURLs() As DataSet
        ...
        ds = URLM.GetAllURLsForReport(AccountId, CategoryId, RegistrarId, SearchBy, Sort, Expiry)
...
#Region "Pirvate functions "
    ...
    Private Function GetFooterText() As String
        ...
        If ReportType = Portal.BLL.Enumeration.ReporType.Support_Billing Then
            Dim ReportMontId As Integer
