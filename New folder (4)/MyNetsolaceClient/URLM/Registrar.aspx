<%@ Page Language="VB" AutoEventWireup="false" EnableTheming="true" Theme="Default" CodeFile="Registrar.aspx.vb" Inherits="URLM_Registrar" %>
...
<body style="margin:0;background-color:#E4F1F7; height:100%; width:100%">
    <form id="form1" runat="server">
        ...
        <div id="DivNew" runat="server"   style=" display:none;border:solid 1px #000000; position:absolute;width:50%;height:220px;top:20%; left:25%;"    >
          <table style="height:100%; width:100%;" cellpadding="0" border="0" cellspacing="0"   >
           <tr>    
              <td align="left" style="border-bottom:solid 1px #000000;padding-top:4px; padding-left:1em;vertical-align:middle; background-image:url(../images/bg_CellNormal_black.jpg);background-repeat:repeat-x; width:100%;">
                  <label id="Label1" title="Notes"    style="color:White;height:100%; overflow:auto; font-weight:bold;"  >New Registrar</label>
              </td>
             ...
             <td colspan="2" style="height:100%; padding:0px; font-size:12px; background-color:#BDE4B8; padding-top:10px;" >
                <table border="0" cellpadding="0" cellspacing="0" width="100%" > 
                  <tr>
                     <td style="width:5%;" ></td>                   
                      ...
                      <td style="width:85%; vertical-align:top; padding-top:0px;">
                        <asp:TextBox ID="txtTitle" ValidationGroup="newCategory"  MaxLength="50" Width="220px" runat="server" SkinID="GreenSmallTextbox"></asp:TextBox>&nbsp;&nbsp;                                                                                                                          
                  ...
                  <tr>
                      ...
                      <td>
                        <asp:TextBox ID="txtDescription" ValidationGroup="newCategory"  MaxLength="50" Width="220px" Height="80px" TextMode="MultiLine" runat="server" SkinID="GreenSmallTextbox"></asp:TextBox>&nbsp;&nbsp;                                                                                                                          
             ...
             <tr class="UnderlinedRow">
                 <td  style="height:31px;background-color:#A0CDEE;font-size:12px;font-weight:bold;padding:5px;width:50%;">
                     <asp:UpdatePanel ID="UpdatePanel1"
                           ...
                           RenderMode="Inline" >
                              <ContentTemplate>
                     Registrar&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;<asp:Label runat="server" ID="lblCount" />
                                    &nbsp;<span class="NonBold">(<asp:Label runat="server" ID="lblFilter" Text="all" />)</span>&nbsp;&nbsp;<asp:Label runat="server" ID="lblError" Text="Registrars with this title already added." Visible="false" CssClass="ErrorMessage" ></asp:Label> 
             ...
             <tr>
                <td colspan="2" style="height:40px;background-color:#BADCFC;font-size:11px;">               
                 <asp:UpdatePanel ID="UpdatePanel3"
                             ...
                             <td colspan="2" style=" height:40px; width:100%; background-color:#BADCFC;" >
                                ...
                                <tr class="UnderlinedRow">
                                    <td style="padding-left:3px;width:130px;padding-bottom:3px;text-align:center;padding-top:11px;">
                                       <asp:LinkButton ID="lnkAddNew"  runat="server" OnClientClick="showNewAccount();  return false;" CssClass="HomeButton">
                   ...
                   <%--       <tr id="tr_newrec" runat="server" style="display:none;">
                             <td colspan="2" style="padding-left:12px;font-size:12px;height:30px; background-color:#BDE4B8;"  >
                                    <span  style="font-size:12px;font-weight:bold;">Title:&nbsp;&nbsp;</span>
                                    <asp:TextBox ID="txtTitle" ValidationGroup="newCategory"  MaxLength="50" Width="120px" runat="server" SkinID="GreenSmallTextbox"></asp:TextBox>&nbsp;&nbsp;                                                                                       
                                    <asp:Button ID="BtnSave" ValidationGroup="newCategory"  runat="server"  CssClass="btn3D"  Height="20px" Width="75px" Text="Add" /> &nbsp;
                                    <asp:Button ID="BtnCancel"  runat="server"  CssClass="btn3D"  Height="20px" Width="75px" Text="Cancel" />
               ...
               <td  colspan="2" style="height:97%;">
                    <div style="overflow:auto;height:100%;background-color:#E4F1F7;border:1px solid #ACBDD5;" id="_gridViewPanel1" class="ScrollBarHomeTicket">
                      <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" >
                         <ContentTemplate>
                            <asp:GridView id="gvRegistrars"
                                   runat="server"
                                    SkinID="GridViewNormal"             
                                   DataSourceID="sdsRegistrars"
                                   EnableTheming="True"
                                   ...
                                   <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Title" SortExpression="DataText">
                                            <EditItemTemplate>
                                                  <asp:TextBox ID="txtTitle" SkinID="GreenSmallTextbox" MaxLength="400" runat="server" Text='<%# Bind("DataText") %>'></asp:TextBox>                                                                                  
                                                   <asp:CustomValidator
                      ...
                      <asp:SqlDataSource 
                           ...
                           DeleteCommand="URLM_Registrar_Delete" DeleteCommandType="StoredProcedure"
                           UpdateCommand="URLM_Registrar_Update" UpdateCommandType="StoredProcedure"
                           InsertCommand="URLM_Registrar_add" InsertCommandType="StoredProcedure"
                           SelectCommand="URLM_RegistrarGetAllForList" SelectCommandType="StoredProcedure">
                           <SelectParameters >  
