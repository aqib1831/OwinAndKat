            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TopBar3DTable">
                <tr>
                    ...
                    <td id="IconNSBS" runat="server" class="MainIcons" title=''>
                      ...
                      <td id="IconURLMWidth" runat="server" style="width:5px;">&nbsp;</td>

                   <td id="IconURLM" runat="server" class="MainIcons" title=''>
                        <table id="IconURLMClass" runat="server" width="100%" border="0" cellspacing="0" cellpadding="0" onmouseover="this.className='TopBarHover';" onmouseout="this.className='TopBarSimple';" class="TopBarSimple" >
                            <tr>
                                <td style="height:33px;"><asp:Image ID="Image6" runat="server" ImageUrl="~/images/icn_urlMngmnt_leftPnl.gif" /></td>
                            </tr>
                            <tr>
                                <td style="height:13px;">URLM</td>
                            </tr>
                        </table>
                    </td>
