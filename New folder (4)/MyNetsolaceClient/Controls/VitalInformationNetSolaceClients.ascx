<%@ Control Language="VB" AutoEventWireup="false" CodeFile="VitalInformationNetSolaceClients.ascx.vb" Inherits="MyNetsolaceClient_Controls_VitalInformationNetSolaceClients" %>
...
<style>
    ...
    #VitalInformationNetSolaceClients_fvLeadVitals_gvSOWLog tr th,#VitalInformationNetSolaceClients_fvLeadVitals_gvBRDLog tr th,#VitalInformationNetSolaceClients_fvLeadVitals_gvAttachments tr th,#VitalInformationNetSolaceClients_fvLeadVitals_GridView2 tr th{
    ...
    #VitalInformationNetSolaceClients_fvLeadVitals_gvSOWLog tr td,#VitalInformationNetSolaceClients_fvLeadVitals_gvBRDLog tr td,#VitalInformationNetSolaceClients_fvLeadVitals_gvAttachments tr td,#VitalInformationNetSolaceClients_fvLeadVitals_GridView2 tr td{
    border-left:none;
    border-right:none;
    text-align:justify;
...
<div align="left" id="FrachiseDetail" style="display: inline; position: absolute; overflow: auto; height:100%;width:348px; top:0px; left: -320px;">
                             ...
                             <asp:HiddenField ID="hdnSubStatus" runat="server" Value='<%#Eval("SubStatus") %>' />
                              <asp:HiddenField ID="hdnIsCorporate" runat="server"  Value='<%# Eval("IsCorporate") %>'/>--%>
                                <div style="height: 100%; width: 100%; overflow:auto; "> 
                                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                      <tr  > 
                                        ...
                                        <td style="height:20px;font-weight:bold;"  align="left" colspan ="3" >                                        
                                            <%# Eval("ProjectManager") %> 
                                        </td>
                                    </tr>
                                    <tr  > 
                                        <td > Product Owner:</td>
                                        <td   align="left" style="height:20px;font-weight:bold;" colspan ="3">  
                                         <%# Eval("ProductOwner") %>   &nbsp; 
                                        </td>
                                    </tr>              
                                    <tr> 
                                ...
                                <% For Each items As System.Collections.Generic.KeyValuePair(Of String, String) In ListOfKey %>
                                    <tr>
                                        <td >
                                        <%= Functions.StringTruncate(items.Key.Trim().ToString().Trim(), 20)    %>: 
                                        </td>
                                    ...
                                    <tr  > 
                                        <td style="height:20px!important;text-align:left;font-weight:bold!important;background-color:#DCECF9;border:1px solid  white;font-size:9;">&nbsp;Document</td>
                                        <td style="height:15px!important;text-align:center;font-weight:bold!important;background-color:#DCECF9;border:1px solid  white;font-size:9;">&nbsp;Posted</td>
                                        <td style="height:20px!important;text-align:center;font-weight:bold!important;background-color:#DCECF9;border:1px solid  white;font-size:9;">&nbsp;CRB Approved</td>
                                        <td style="height:20px!important;text-align:center;font-weight:bold!important;background-color:#DCECF9;border:1px solid  white;font-size:9;">&nbsp;SOW Approved</td>                                        
                                    </tr>
                                    <tr>
                                        <td  title="<%#Eval("DocumentName")%>" style="font-weight:500;font-size:10px;text-align:left;padding-left:4"><a href='#' onclick="javascript:OpenAttachment('<%# ResolveUrl("Downlaod.aspx?dt=" & Functions.EncryptData(DateTime.Now) & "&AttachmentID=") & Functions.EncryptData(Eval("AttachmentID")) %>');"><%# StringShort(Eval("DocumentName"), 20)%>&nbsp; </a></td>
                                    ...
                                    <tr id="sowrow" runat="server"> 
                                        <th style="height:20px;font-weight:bold;border-top:1px solid #7DA4CD;" colspan="4" align="left">&nbsp;SOW Log</th>
                                    </tr>              
                                                 ...
                                                 <Columns>
                                                    ...
                                                    <asp:TemplateField  HeaderText ="Document Name"  HeaderStyle-HorizontalAlign ="Left" HeaderStyle-Font-Bold="true" >
                                                        <ItemTemplate>
                                                            ...
                                                            <a href='#' onclick="javascript:OpenAttachment('<%# ResolveUrl("../PM/Downlaod.aspx?dt=" & Functions.EncryptData(DateTime.Now) & "&AttachmentID=") & Functions.EncryptData(Container.DataItem("ID")) %>');"><%# StringShort(Container.DataItem("FileName"))%></a> 
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                    ...
                                    <tr id="brdrow" runat="server"> 
                                        <th style="height:20px;font-weight:bold;border-top:1px solid #7DA4CD;" colspan="4" align="left">&nbsp;BRD</th>
                                    </tr>              
                                        ...
                                        <td colspan="4">
                                            <asp:GridView ID="gvBRDLog" Width="100%" OnDataBound="gvBRDLog_DataBound" OnRowDataBound="gvBRDLog_RowDataBound" runat="server" DataSourceID ="odsGetBRDLog" AutoGenerateColumns="false">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText ="User" HeaderStyle-HorizontalAlign ="Center" HeaderStyle-Font-Bold="true">
                                                        <ItemTemplate>
                                                          &nbsp;&nbsp; <asp:Label runat="server" ID="FNamelblBrd" Text='<%# Eval("FirstName") %> &nbsp;' ></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                            ...
                                            <asp:GridView ID="gvAttachments" Width="100%"  runat="server" DataSourceID ="odsGetAttachmentLog" OnRowDataBound="gvAttachments_RowDataBound" AutoGenerateColumns="false">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText ="Document Name" HeaderStyle-HorizontalAlign ="Left" HeaderStyle-Font-Bold="true">
                                                        <ItemTemplate>
                                                           <%--<span class="bluetext">  <%# Eval("FileName") %> &nbsp;</span>--%>
                                                           <a href='#' onclick="OpenAttachment('<%# IIf(Container.DataItem("NoteAttachment") = 1, ResolveUrl("../PM/Downlaod.aspx?dt=" & Functions.EncryptData(DateTime.Now) & "&AttachmentID=") & Functions.EncryptData(Container.DataItem("ID")), ResolveUrl("../PM/Downlaod.aspx?dt=" & Functions.EncryptData(DateTime.Now) & "&TicketID=") & Functions.EncryptData(Container.DataItem("ID")))%>');"><%# StringShort(Container.DataItem("FileName")) %></a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText ="Posted" HeaderStyle-HorizontalAlign ="Center" HeaderStyle-Font-Bold="true">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText ="User" HeaderStyle-HorizontalAlign ="Center" HeaderStyle-Font-Bold="true">
                                                        <ItemTemplate>
                                                          &nbsp;&nbsp;    <asp:Label ID="Hourslbl" runat="server" Text='<%# Eval("FirstName") %> &nbsp;' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
