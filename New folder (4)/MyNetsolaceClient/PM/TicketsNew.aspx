			   ...
			   <td align="center" style="vertical-align:top; height:100%; width:100%;">
				   ...
				   <table border="0" cellpadding="1"  cellspacing="0" class="FormInnerTable" style="width:100%;  height:100%; text-align:left; vertical-align:top;" >
					   ...
					   <tr style="padding-top:2px;">
						   ...
						   <td style="padding-left:20px;">
								<asp:DropDownList ID="ddlCategories" AutoPostBack="true" runat="server" DataSourceID="SDS_Categories"
								   DataTextField="Name" DataValueField="ID" SkinID="SmallTextCombo" Width="200px">
							   </asp:DropDownList>
					   ...
					   <tr id="trAreaDeveloperWhiteLine" runat="server" visible="false"><td class="WhtLine" colspan="4"><img /></td></tr>
					   <tr style="padding-top:2px;" id="trAreaDeveloper" runat="server" visible="false">
					       <td>&nbsp;&nbsp;Area Developer:</td>
					       <td style="padding-left:20px;">
					           <asp:DropDownList ID="ddlAreaDeveloper" CssClass="SmallFontInput" runat="server" Width="200px" DataSourceID="odsAreaDeveloper" DataTextField="CorporateName" DataValueField="ID">
                               </asp:DropDownList>     
                                <asp:ObjectDataSource ID="odsAreaDeveloper" runat="server" TypeName="Portal.BLL.AreaDeveloper"
							            SelectMethod="GetAllByClientId">
							        <SelectParameters>
							                <asp:ControlParameter ControlID="hdnClientID" Name="ClientID" />										
							        </SelectParameters>
					       ...
					       <td >
					           <asp:DropDownList ID="ddlTicketOwner" runat="server" DataSourceID="sdsTicketOwner" DataTextField="OwnerName"
									...
									<asp:SqlDataSource ID="sdsTicketOwner" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
										SelectCommand="PM_TicketOwner_GetAll" SelectCommandType="StoredProcedure" DataSourceMode="DataReader">
									</asp:SqlDataSource>
					                </td> 
					   </tr>
                       <tr id="tr2" runat="server" ><td class="WhtLine" colspan="4"><img /></td></tr>
                         <tr style="padding-top:2px;" id="tr1" runat="server" visible="true">
						   ...
						   <td colspan="4" style="text-align:center; height:100%; padding-left:0px;">
							  <%-- <asp:TextBox ID="txtDescription" runat="server" Height="96%" MaxLength="500" SkinID="GreenMultilineTextbox" TextMode="MultiLine"  Width="100%" ></asp:TextBox--%> 
                               <textarea name="editor1" id="editor1" runat="server"></textarea>
                                <asp:RequiredFieldValidator ID="RFV_txtDescription" runat="server" ControlToValidate="editor1"
