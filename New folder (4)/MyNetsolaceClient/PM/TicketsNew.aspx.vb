...
Partial Class PM_TicketsNew
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If String.IsNullOrEmpty(Request.QueryString("PrevPage")) = False AndAlso IsNumeric(Request.QueryString("PrevPage")) Then
                Select Case CInt(Request.QueryString("PrevPage"))
                    Case 3 'Tickets
                        btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/MyNetsolaceClient/PM/MyTickets.aspx?ddlClients=" & tktClient & "&ddlCategories=" & tktCatagory & "&ddlFilter=" & tktFilter & "&ddlTypes=" + tktTypes) & "'; return false; ")
                    Case 4 'MyTickets
                        btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/MyNetsolaceClient/PM/MyTickets.aspx?ddlClients=" & tktClient & "&ddlCategories=" & tktCatagory & "&ddlFilter=" & tktFilter) & "'; return false; ")
                    Case 5 'Tickets History
                        btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/MyNetsolaceClient/PM/TicketsHistory.aspx?ddlClients=" & tktClient & "&ddlCategories=" & tktCatagory & "&ddlFilter=" & tktFilter) & "'; return false; ")
                    Case Else
        ...
        End If
        If Session("MyNetsolace_ClientID") = "1" Then ' Mean its is Edible Arrangement Client
            trAreaDeveloper.Visible = True
            trAreaDeveloperWhiteLine.Visible = True
        End If
    End Sub
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
		...
		If Session("MyNetsolace_ClientID") = "1" Then ' Mean its is Edible Arrangement Client
                If ddlAreaDeveloper.SelectedValue > 0 Then
                    .AreaDeveloperId = Me.ddlAreaDeveloper.SelectedValue
                End If
		End If
