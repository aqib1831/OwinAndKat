Partial Class PM_MyTickets
    ...
    Private Sub FillddlFilter()
        ...
        ddlFilter.Items.Add(obj)
        obj = New System.Web.UI.WebControls.ListItem("Assigned To Me", 2)
        ddlFilter.Items.Add(obj)
    ...
    Protected Sub ddlFilter_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlFilter.SelectedIndexChanged
        hdnSearch.Value = ""
        'Dim st As String = CType(ddlFilter.SelectedItem.Text, String)
        'If st.Equals("Assigned To Me") Then
        '    [PM_Tickets_Features_MyTickets_GetAll]
        'End If
    End Sub
End Class