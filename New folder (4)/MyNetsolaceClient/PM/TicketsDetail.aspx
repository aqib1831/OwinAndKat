<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TicketsDetail.aspx.vb" Inherits="PM_TicketsDetail" ValidateRequest="false" Theme="Default" %>
<%@ Register TagPrefix="radU" Namespace="Telerik.WebControls" Assembly="RadUpload.Net2" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/MyNetsolaceClient/Controls/VitalInformationNetSolaceClients.ascx" TagPrefix="uc1" TagName="VitalInformationNetSolaceClients" %>
...
<body style="margin:0px;width:100%;height:100%;" onResize="OnResize();">
 <form id="form1" runat="server" >
     
       <uc1:VitalInformationNetSolaceClients runat="server" ID="VitalInformationNetSolaceClients" />
    ...
    <asp:UpdateProgress ID="Progress1" runat="server">
      ...
      <table   style="width:100%;height:100%;background-color:#FFFFFF;" class="MainTable" border="0" align="center" cellpadding="0" cellspacing="0">
         
          <tr>    <td style="padding: 5px;" onclick="if (blnShowed == true){showHideVital();}">
              <%--<td style="width: 27px;">
            ...
            <asp:UpdatePanel ID="upHiddens" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                <ContentTemplate>
                    <asp:HiddenField ID="hdnClientContactIds" runat="server" Value=""  />
                    <asp:HiddenField ID="hdnNewClientContactIds" runat="server" Value=""  />                        
                </ContentTemplate>
            </asp:UpdatePanel> 
       
                  <table style="width:100%;height:85px;background-color:#DDE4EE;padding-left:25px;margin-top:-3px!important "  border="0" cellpadding="0" cellspacing="0" class="SimpleExSmall">
                   <tr>
                      <td height="31" colspan="5">
                          <table cellpadding="0" cellspacing="0" border="0"  width="100%" style="background-color:#BDE7BD;">
                                <tr>
                                   <td height="31" class="SimpleBold" style="width:150px;padding-left:5px;color:#000000;border-bottom:1 solid #609BD3;">
                                    &nbsp;<asp:Label ID="lblTitle" runat="server" Text="Ticket Detail"></asp:Label>&nbsp; <asp:image ID="ImgPriority" runat="server" />                                    
                                    </td>
                                    <td style="background-color:#BDE7BD;color:#000000;border-bottom:1 solid #609BD3;">&nbsp;       <asp:DropDownList ID="linkedTickets" runat="server" 
                                                            onchange="YourChangeFun(this);" Width="150" Height ="20" Font-Size ="8" OnDataBound="linkedTickets_DataBound" DataTextField="Subject"
                                                            DataValueField="Link_Ticket_Feature_ID">
                                    ...
                                    <td style="background-color:#BDE7BD;color:#000000;border-bottom:1 solid #609BD3;">&nbsp;</td>
                                            <td align="right" class="SimpleBold" style="width: 60px; text-align: left; background-color: #BDE7BD; color: #000000; border-bottom: 1 solid #609BD3;">
					...
					<tr style="background-color:#DEF7D6;">                        
                        <td style="padding-top:5px;">&nbsp;&nbsp;&nbsp;From: <asp:Label runat="server" ID="lblAssignBy" Font-Bold="true"  /></td>                        
                        <td style="padding-top:5px;">&nbsp;&nbsp;&nbsp;Due Date: <asp:Label runat="server" ID="lblDueDate" Font-Bold="true" /></td>
                        <td style="padding-top:5px;">&nbsp;&nbsp;&nbsp;Category: <asp:Label runat="server" ID="lblCategoryName" Font-Bold="true" /></td>
                        <td  style="padding-top:5px;" colspan="4"><asp:Label runat="server" ID="lblClientName" style="display:none;" /></td>
                    </tr>
                      <tr id="trAreaDeveloper" runat="server" style="background-color: #DEF7D6;">
                        <td id="tdAreaDeveloper" runat="server" visible="false"  style="height:31px;">&nbsp;&nbsp;&nbsp;Area Developer:&nbsp;<asp:Label ID="lblAreaDeveloper" runat="server" Font-Bold="true"></asp:Label></td>                        
                        <td id="tdproductowner" runat="server" visible="false"  style="height: 31px;">&nbsp;&nbsp;&nbsp;Product Owner:&nbsp;<asp:Label ID="lblTicketOwner" runat="server" Font-Bold="true"></asp:Label></td>
                   <td  style="height: 31px;" class="SimpleExSmall">&nbsp;&nbsp;&nbsp;Type: <asp:Label runat="server" ID="lblActivityType" Font-Bold="true" /></td>                        
                        <td id="tdAreaDeveloper2" runat="server" visible="false"  style="height:31px;">&nbsp;</td> 
						<td id="tdSubCategory"  style="height: 31px;" class="SimpleExSmall">Sub Category:
                                    <asp:Label runat="server" ID="lblSUbCategory" Font-Bold="true" /></td>
                          <td colspan="3"></td>
                      </tr>
...
<img src="../../images/ico_attachment.gif" align="middle" alt="attach" /></td>
            ...
            <table style="width:100%; height:100%; vertical-align:top;" border="0" cellpadding="0" cellspacing="0">
			   <tr>
					<td style=" width:100%; height:100%; vertical-align:top;">
						<table id="DivRepeaterAndContacts" cellspacing="0" cellpadding="0" style="width:100%;height:100%;padding-left:15px">
							<tr>
								<td id="DivNotes" colspan="2" style="display: none;height:110px">
									<div  style="height:110px;padding:3px;padding-left:10px;width:100%;filter:progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#E7F7E1,endColorStr=#DEF7D6;);background-color:#DAF5D6; border-bottom:solid 1px #609BD3;">
                                                    <table style="width: 100%;padding-left:15px; height: 100px;" cellpadding="0" cellspacing="0" border="0" ondblclick="event.cancelBubble=true;">
                                                        <tr>
                                                            <td colspan="2" valign="middle" class="SimpleExSmallBold">Notes: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Assigned To: &nbsp; 
                                                                <asp:DropDownList ID="ddlAssignedto" runat="server" Width="190px" CssClass="SmallFontInput"
                                                                    DataSourceID="sdsAssginedto" DataTextField="UserName" DataValueField="ID" AppendDataBoundItems="true" >
                                                                    <asp:ListItem Text="Please Select" Value="0" />
                                                                </asp:DropDownList>&nbsp;
                                                                <%--<asp:CompareValidator ID="cvAssignTo" runat="server" ValueToCompare="0" Display="Dynamic"
                                                                    ErrorMessage="Please select assign to" Operator="GreaterThan" ControlToValidate="ddlAssignedto"
                                                        ...
                                                        <tr>
                                                            <td class="SimpleExSmallBold">
                                                                ...
                                                                <div style="padding-top: 5px;">
                                                                              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNotes"
                                                                                    ValidationGroup="NotesAdd" ErrorMessage="Enter Notes" Display="Dynamic" Enabled="true" CssClass="RequiredField" />
                                                                                <%--<asp:RegularExpressionValidator SetFocusOnError="true" ValidationGroup="NotesAdd" ID="RegularExpressionValidator1"
                                                                                    runat="server" Display="Dynamic" ControlToValidate="txtNotes" ValidationExpression="^[^<>]*$"
                                                                                    ErrorMessage="Special Characters are not allowed" CssClass="RequiredField"></asp:RegularExpressionValidator>--%>
                                                                            </div>
                                                            </td>
                                                            <td style="width: 20%; text-align: center; vertical-align: top;" class="SimpleExSmallBold">
                                                                <table cellpadding="0" cellspacing="0" align="center">
															     ...
															     <div class="LeadDetailGreenButton"> Attach File</div>
                                                                            </asp:LinkButton>
                                                                            <div style="padding-top: 5px;">
                                                                                <asp:Button runat="server" ID="btnSave" Style="height: 20px; width: 100px;" OnClientClick="if (OnSaveClientSide() == false) return false;"
                                                                                    ValidationGroup="NotesAdd" CssClass="LeadDetailGreenButton" Text="Save" />
                                                                            </div>
                                                                        </td>
                                        ...
                                        <asp:SqlDataSource ID="sdsAssginedto" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
                                            SelectCommand="PM_Ticket_Features_Users_GetByGroup" SelectCommandType="StoredProcedure"
                                            DataSourceMode="DataReader">
                                            <SelectParameters>
                                                <asp:ControlParameter Name="TicketID" DefaultValue="0" ControlID="hdnID" Type="int32" PropertyName="value" />
                                                <asp:ControlParameter Name="GroupID" DefaultValue="0" ControlID="hdnGroupID" Type="Int32" PropertyName="value" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
									</div>
								</td>
							...
							<tr valign="top">
								<td style="width:100%;height:100%;">
								<div id="DivNotesDisplay"  runat="server"  style="width:100%;height:100%;padding-left:15px; overflow-y:scroll;" class="DivScroll" onDblClick="Notes();">
									 <asp:UpdatePanel ID="UpdatePanel2"
										 ...
										 <ContentTemplate>
                                             <asp:Repeater ID="rptrNotes" runat="server" DataSourceID="sdsNotes" EnableViewState="false">
                                                 ...
                                                 <ItemTemplate>
                                                     <tr>
                                                         <td style="border-bottom: 1px solid #BDE4B8; border-bottom-style: dashed; padding-left:5px;">
                                                             <br />
                                                             ...
                                                             <div style="<%#IIF( Cbool(Eval("Type")) = True , "color:Blue;","color:Black;") %>">
                                                                <br /> <%#CType(Container.DataItem("Notes"), String)%> <br /></div>
                                            ...
                                            <ItemTemplate>
	                                            <table cellpadding="0" cellspacing="0" border="0" style="font-size: 11px;width:98%;">
		                                            ...
		                                            <tr><td style="padding-left:5px;"><br /><div><%#Container.DataItem("Description")%></div><br /><br /></td></tr>
                                                            ...
                                                            <tr valign="top">
                                                                <td style="height: 45px; width: 100%; padding: 0px;">
                                                                    <asp:Panel ID="pnlsearch" runat="server" DefaultButton="btnSearch">
                                                                        <div style="border-color: #F5F5F5; background-color: #DEF7D6; padding-top: 3px; padding-left: 7px; border-bottom: solid 1px white;" class="SimpleExSmallBold">
                                                                            <asp:TextBox ID="txtClientUserSearch" runat="server" Height="18" Width="140" onkeyup='SearchUsers(this);' Style="vertical-align: top;"></asp:TextBox>
                                                                            ...
                                                                            <asp:ImageButton ID="btnSearch" runat="server" OnClientClick="txtClientUserSearch.onkeyup(); return false;" ImageUrl="~/images/btn_go.gif" />
                                                                        </div>
                                                                    </asp:Panel>
                                                                    <div style="border-color: #F5F5F5; background-color: #DEF7D6; height: 20px; padding-bottom: 1px; white-space: nowrap; padding-left: 5px;" class="SimpleExSmallBold">
                                                                        <asp:Label ID="lblContactClientName" runat="server"></asp:Label>&nbsp;Contacts:
                                                                    </div>
                                                                </td>
											</tr>
											<tr style="width:100%;" valign="top">
												<td style="width:100%;padding:0px;">
													...
													<asp:UpdatePanel ID="upnlClientContacts" runat="server" UpdateMode="Conditional">
														<ContentTemplate>
																<asp:Repeater ID="rptClientContacts" runat="server" DataSourceID="odsClientContacts" >
																<HeaderTemplate>
																	   <div id="dvClientContacts" class="SimpleExSmallBold">
																</HeaderTemplate>
																<ItemTemplate>
																	<div>
                                                                                            <input type="checkbox" id="chkClientContacts" tooltip='<%# Eval("ClientUserName")%>' runat="server" checked='<%# Eval("Checked") %>' clientcontactid='<%# Eval("ClientContactID") %>' prevclientchecked='<%# Eval("Checked") %>' onclick="OnClientContactChecked(this)" /><label><%# Functions.StringTruncate(Eval("ClientUserName"), 15) %></label>
																	</div>
																</ItemTemplate>
																<FooterTemplate></div></FooterTemplate>
																</asp:Repeater> 
																<asp:ObjectDataSource  
																   ID="odsClientContacts" 
																   runat="server"
																   SelectMethod="PM_Ticket_Features_Users_ClientContacts"
																   TypeName="Portal.BLL.PM.PM_Ticket_Features_Users">
																   <SelectParameters>
																		<asp:ControlParameter Name="ClientID" DefaultValue="0"  ControlID="hdnClientID" Type="int32" PropertyName="value" />
																		<asp:ControlParameter Name="TicketID" DefaultValue="0"  ControlID="hdnID" Type="int32" PropertyName="value" />
																		<asp:SessionParameter SessionField="Mynetsolace_AreaDeveloperId" Name="AreaDeveloperId" />
																   </SelectParameters>
																   </asp:ObjectDataSource>																
															</ContentTemplate>
															</asp:UpdatePanel>
												...
												<tr>
													<td style="height:30px;border-color:#F5F5F5; background-color:#DEF7D6;" align="center">													
                                                                    <asp:Button runat="server" ID="btnUpdateUsers" Style="height: 20px; width: 80px;" CssClass="LeadDetailGreenButton" OnClientClick="clearSearchUser(); return UpdateContacts();" Text="Update" />
													</td>
												</tr>
									  </table>
								</ContentTemplate>
                ...
                <tr style="background-color: #BDE7BD; height: 35px;padding-left:10px">
             ...
             <asp:HiddenField ID="hdnWaitingFor" runat="server" Value="0" /> 
                                ...
                                <asp:ListItem Text="On Hold" Value="7"></asp:ListItem>
                                        ...
                                        <td class="SimpleExSmall" align="left">
							...
							<asp:Button ID="BtnConfirmNO" runat="server" CssClass="Btn3D" Text="No" Width="70px" OnClientClick="SelectStatusDDL(9);" /></span>
                                        ...
                                        <%--When this approved please also impliment this on PM seciton --%>
                                        <td class="SimpleExSmall" align="left">
                                            <div id="dvIsfeedbackRequired" runat="server" style="vertical-align: middle; white-space: nowrap;">
                                                &nbsp;
							                    <img src="../../images/ico_alert.gif" align="middle" />&nbsp;&nbsp;
                                                <span style="padding-top:5px; position:absolute; font-weight:bold;">Please provide your feedback. &nbsp;
						                    </span>
                                            </div>
                                        </td>

                     <td style="width:24%; white-space:nowrap;" align="right">                             
			...
			<td width="100%" valign="top" colspan="2">
				<table align="center" width="100%" cellpadding="0" cellspacing="0" class="MainAlertDiv" style="width:100%;text-align:center;border:none;">
					...
					<div>
                     ...
                     <div>
						<div>File 2: <input id="file2" type="file" runat="server" style="width:330px;"/><asp:RadioButton ID="RadioButton2" GroupName="selectSowBrd1" runat="server" Text="SOW" CssClass="hdng_Radio" />
                     ...
                     <div >
                     <div>File 3: <input id="file3" type="file" runat="server" style="width:330px;"/> <asp:RadioButton ID="RadioButton5" GroupName="selectSowBrd2" runat="server" Text="SOW" CssClass="hdng_Radio" />
	...
	<div id="divSurvey" style="width:635px; position: absolute;display: none; z-index: 20;"></div>
 </form>
...
function ShowUpdateMessage() {
    document.getElementById('spnUpdateMessage').style.display = '';
...
divDisable.style.display = 'none';
    ...
    function ShowSurveyForm() {    
        $.ajax({
            ...
            url: 'survey.aspx',
            cache: false,
            data: '<%= Request.QueryString().ToString() %>&ScrollHeight=' + document.body.scrollHeight,
            success: OnSuccess,
            dataType: 'html'
        });
        
        if (document.body.scrollHeight < 600)
            document.getElementById('divSurvey').style.height = '490px';
        else
            document.getElementById('divSurvey').style.height = '545px';   
           
        CenterAlignDiv(document.getElementById('divSurvey'));
        document.getElementById('divSurvey').style.display = 'inline';        
        BlackDivDisplay();
    }
...
function SelectStatusDDL(value) {
    ...
    function OnResize() {
        ...
        if (divSurvey.style.display == 'inline')
            CenterAlignDiv(document.getElementById('divSurvey'));
    }

    function UpdateContacts() {
        var hdnClientContactIds = document.getElementById('<%= hdnClientContactIds.ClientId %>');
        var hdnNewClientContactIds = document.getElementById('<%= hdnNewClientContactIds.ClientId %>');
        if (hdnClientContactIds.value == hdnNewClientContactIds.value)
            return false;
        else
            return true;
    }

    function OnClientContactChecked(chkbox) {
        var hdnNewClientContactIds = document.getElementById('<%= hdnNewClientContactIds.ClientId %>');        
        if (chkbox.checked)
            hdnNewClientContactIds.value += chkbox.getAttribute("ClientContactID") + ","
        else
            hdnNewClientContactIds.value = hdnNewClientContactIds.value.toString().replace(chkbox.getAttribute("ClientContactID") + ",", '')        
    }
    ...
    //    }
    //    else {
    //        var isANumber = isNaN(text) === false;
    //        if (isANumber == true) {
    //            window.location = "TicketsDetail.aspx?ID=" + text
    //        }
    //    }
    ...
    function YourChangeFun(ddl) {
        ...
        else {  //var TicketNumber =ddl.options[ddl.selectedIndex].val()
