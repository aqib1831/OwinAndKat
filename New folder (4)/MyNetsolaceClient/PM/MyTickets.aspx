...
<body  style ="margin :0px;background-color:#E4F1F7;" >
	...
	<table width="100%" style="height:100%; margin:0px; padding:0px;background-color:#E4F1F7; " cellspacing="0" cellpadding = "0" border="0">
			 <tr class="UnderlinedRow">
				 <td  style="height:20px;background-color:#A0CDEE;font-size:12px;font-weight:bold;width:30%;">
					<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
						<ContentTemplate>
							<pre style="height:20px;font-family:Arial;font-size:12px;font-weight:bold;padding:3px;float:left;">My Tickets  |  <asp:Label runat="server" ID="lblErrorCount" />&nbsp;(<asp:Label runat="server" ID="lblFilter" Text="all" class="NonBold" />)</pre>
						</ContentTemplate>
						<Triggers >
				 ...
				 <td style="background-color:#A0CDEE;padding:3px;text-align:right;width:70%;">
                     <div style="width: 130px;" class="LeadDetailButton" onclick="printReport(2)">
                         Export To Excel
                         <img id="Img9" src="../../images/blt_resetFilters.gif" align="absmiddle" width="10"
                             height="10" style="border: 0px;" />
                     </div>
                     &nbsp;
