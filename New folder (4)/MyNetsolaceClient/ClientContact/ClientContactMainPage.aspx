<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MyNetsolaceClient/MyNetsolace.master" CodeFile="ClientContactMainPage.aspx.vb" Inherits="MyNetsolace_ClientContactMainPage" %>
<%@ Register Src="~/MyNetsolaceClient/ClientContact/LeftPanelMyClientContact.ascx" TagName="leftPanelMyClientContact" TagPrefix="MyClientContact" %>
