<%@ Page Language="VB" AutoEventWireup="false" CodeFile="QSEditLicenseDetail.aspx.vb" Inherits="LM_QsLicenseDetail" ValidateRequest="false" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Edit Qs Licence Details</title>
...
<body style="margin:0; padding:0; height:100%;" onload="OnChangeRadio();">
    ...
    <tr style="height:30px; background-image:url(../images/bg_mainHdr_1.jpg);">
        <th colspan="3" align="left" class="IdeaTitle">Edit Qs License Details</th>
   ...
   <tr>
    ...
    <tr>
        ...
        <td align="right" style="padding-right:7px;border-bottom:0;">
            <asp:Label ID="lblNotesCount" runat="server" Text="500"></asp:Label><span>&nbsp;Characters Remaining</span>
        </td>
    </tr>
    <tr style="height:100%;">
