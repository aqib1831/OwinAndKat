<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditDFLicenseDetail.aspx.vb" Inherits="LM_EditSMSXLicenseDetail" %>
...
<body style="margin:0; padding:0; height:100%;" onload="OnChangeRadio();">
    ...
    <tr style="height:30px;background-image:url('../images/bg_mainHdr_1.jpg');" class="GalleryTitle">
        <td colspan="3" align="left" class="IdeaTitle">Edit DF License Details</td>
