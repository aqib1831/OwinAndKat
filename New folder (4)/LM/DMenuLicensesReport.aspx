<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DMenuLicensesReport.aspx.vb" Inherits="LM_nXstepLicensesReport"  %>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>nxStep Licenses Report</title>
    <style type="text/css">
    .HeaderRow
    {
        font-size:9pt;
                ...
                <td  align="center">
                    ...
                    <tr>
                        <td align="center" style="height:50px;">
                            ...
                            <div style="width:100%; text-align:center;" class="ReportName">DMenu Licenses</div>
                    ...
                    <tr>
                            <td style="background-color:#FFFFFF;border:0;" valign="top" id="td1" >
                                ...
                                <ItemTemplate>
                                        <table style="margin: 0px; border: 0px;" cellpadding="0" cellspacing="0" border="0" width="100%">
                                         <tr>
                                            ...
                                            <td align="center" style="width: 8%;" class="ItemRow">
                                                <%#Eval("NumberOfDisplays") %>  
                                                &nbsp;
                                            </td>
                                            <td align="left" style="width: 8%;" class="ItemRow">
                               ...
                               <asp:ObjectDataSource ID="odsSBSLicenses" runat="server" TypeName="Portal.BLL.LM.DMenuLicenseManagement" 
                                SelectMethod="GetAllDMenuLicensesForReporting">
                                <SelectParameters>
