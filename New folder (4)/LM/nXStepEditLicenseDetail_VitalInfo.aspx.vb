...
Partial Class DMenu_EditLicenseDetail_VitalInfo
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Dim result As Integer = Portal.BLL.NS.NS_Products_Franchises.NS_Products_FranchisesUpdate_nxStep(Request.QueryString("ID"), txtSystemIP.Text, chkStaticIP.Checked)
