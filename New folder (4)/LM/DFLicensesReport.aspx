<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DFLicensesReport.aspx.vb" Inherits="LM_SMSXLicensesReport" %>

<%--<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
--%>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>DF Licenses Report</title>
    <style type="text/css">
    .HeaderRow
    {
        font-size:9pt;
                ...
                <td  align="center">
                    ...
                    <tr>
                        <td align="center" style="height:50px;">
                            ...
                            <div style="width:100%; text-align:center;" class="ReportName">DF Licenses</div>
                    ...
                    <tr>
                            <td style="background-color:#FFFFFF;border:0;" valign="top" id="td1" >
                                ...
                                <asp:Repeater ID="rptReport" runat="server" DataSourceID="odsDFLicenses">
                                <HeaderTemplate>
                                    <table style="margin: 0px; border: 0px;" cellpadding="4" cellspacing="4" border="0" width="100%">
                                        <tr  class="HeaderRow" >
                                            <td  align="right" style="width:6%;" valign="middle"  class="TableHeading"  >
                                                St#
                                            </td>
                                            <td  align="left"  style="width: 29%;" class="TableHeading" >
                                                Store Nick
                                            </td>                                            
                                ...
                                <ItemTemplate>
                                        <table style="margin: 0px; border: 0px;" cellpadding="0" cellspacing="0" border="0" width="100%">
                                         <tr>
                                            <td style="width: 6%;height:25px;" align="right" class="ItemRow" >
                                                <%#Eval("StoreNumber")%>
                                                  &nbsp;
                                            </td>
                                            <td style="width:29%;" align="left"  class="ItemRow">
                                                <%#Eval("StoreNick")%>
                                            ...
                                            <td style="width: 9%;" align="center" class="ItemRow">
                                                 <%#IIf(Eval("TerminalCount") Is DBNull.Value, 0, Eval("TerminalCount"))%>
                                                
                                            </td>
                                            <td style="width: 18%;padding-left:5px;" align="center" class="ItemRow">
                                                 <%#Eval("CurrentVersion")%>                                                 
                                            </td>
                               ...
                               <asp:ObjectDataSource ID="odsDFLicenses" runat="server" TypeName="Portal.BLL.DFLicenseManagement" 
                                SelectMethod="GetAllDFLicensesForReporting">
                                <SelectParameters>
