<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DMenuLicenseDetail.aspx.vb" Inherits="DMenu_LicenseDetail" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>DMenu License Management</title>
        ...
        <td style="width:33%;padding:0;padding-right:10px;">
             <table cellpadding="0" cellspacing="0" border="0" class="tblDetail" style="width:100%;padding:0px;" >
                <tr>
                    ...
                    <td style="border-bottom:0;padding:0; width:80px;" align="right">
