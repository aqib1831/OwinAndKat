...
Partial Class LM_SMSXLicenseManagement
    ...
    Function FilterChecks()
        If Functions.IsSuperAdmin(CInt(Session("AdminID"))) Then
            odsSBSSMSXLicenses.SelectMethod = "GetAllSMSXLicenses"
            odsSBSSMSXLicenses.SelectCountMethod = "GetAllSMSXLicensesCount"
            sdsClients.SelectCommand = "Clients_GetALL"
        Else
            odsSBSSMSXLicenses.SelectMethod = "GetAllSMSXLicenses_LM"
            odsSBSSMSXLicenses.SelectCountMethod = "GetAllSMSXLicensesCount_LM"
            If odsSBSSMSXLicenses.SelectParameters("UserID") Is Nothing Then
                odsSBSSMSXLicenses.SelectParameters.Add("UserID", CInt(Session("AdminID")))
            End If
