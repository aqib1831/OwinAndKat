<%@ Page Language="VB" AutoEventWireup="false" Debug="true" CodeFile="NewDFLicenses.aspx.vb" Inherits="LM_NewDFLicenses" %>
            ...
            <tr>
                ...
                <td>
                   <asp:DropDownList ID="ddlProducts" style="font-size:11px;" runat="server" Width="200px" onchange="return CheckQuantityField(this);">
                        <asp:ListItem Text="DF bundle" Value="1"></asp:ListItem>
                        <asp:ListItem Text="DF additional" Value="2"></asp:ListItem>                        
                   </asp:DropDownList>
                </td>
            </tr>
