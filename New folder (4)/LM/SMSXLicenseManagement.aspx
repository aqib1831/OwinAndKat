...
<asp:ObjectDataSource ID="odsSBSSMSXLicenses" runat="server" TypeName="Portal.BLL.SMSXLicenseManagement" 
     SelectMethod="GetAllSMSXLicenses" MaximumRowsParameterName="maximumRows" StartRowIndexParameterName="startRowIndex" 
     SelectCountMethod="GetAllSMSXLicensesCount" SortParameterName="sortBy" EnablePaging="true" EnableViewState="true">
    <SelectParameters>
...
<asp:SqlDataSource ID="sdsStates" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowNewLicenseDiv(){            
            ...
            ifNewLicense.location='NewSMSXLicenses.aspx';
        ...
        function ShowDetail(licenseId){
          ...
          window.location='SmsxLicenseDetails.aspx?LicenseID='+licenseId+'&ddlClient='+ddlClient+'&ddlStates='+ddlStates+'&ddlFilters='+ddlFilters;
        }
