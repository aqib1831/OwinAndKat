<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditLicenseDetailDC.aspx.vb" Inherits="LM_EditLicenseDetailDC" ValidateRequest="false"   %>

<head id="Head1" runat="server">
    <title>Edit DC License Detail</title>
...
<body style="margin:0; padding:0; height:100%;">
    ...
    <tr style="height:30px; background-image:url(../images/bg_mainHdr_1.jpg);">
        <th colspan="3" align="left" class="IdeaTitle">Digital Catalog License Detail</th>
