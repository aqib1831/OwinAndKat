Imports System.Data
Partial Class LM_LicenseManagement
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            If (Request.QueryString("PrevPage") <> Nothing And Request.QueryString("PrevPage") = "MyNetsolace") Then
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "ChangeSelected", "parent.SetSelected2(1); document.getElementById('tdnewbtn').style.display='none';", True)
    ...
    Protected Sub odsSBSLicenses_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles odsSBSLicenses.Selected
    ...
    End Sub
    Protected Function FilterChecks()

        'If Portal.BLL.Enumeration.Users.Khurram_Ali = CInt(Session("AdminID")) Or CInt(Session("AdminID")) = 3004 Or CInt(Session("AdminID")) = 3852 Or CInt(Session("AdminID")) = 3551 Or CInt(Session("AdminID")) = 1 Then 'Check for super users
        '    odsSBSLicenses.SelectMethod = "GetAllNextStepLicenses"
        '    odsSBSLicenses.SelectCountMethod = "GetAllNextStepLicensesCount"
        '    sdsClients.SelectCommand = "Clients_GetALL"

        'Else
        odsSBSLicenses.SelectMethod = "GetAllNextStepLicensesByLMUserAccess"
        odsSBSLicenses.SelectCountMethod = "GetAllNextStepLicensesByLMUserAccessCount"
    ...
    Function CheckForLMRights()

        'If Portal.BLL.Enumeration.Users.Khurram_Ali <> CInt(Session("AdminID")) And CInt(Session("AdminID")) <> 3004 And CInt(Session("AdminID")) <> 3852 And CInt(Session("AdminID")) <> 3551 And CInt(Session("AdminID")) <> 1 Then

        Dim objUserAccess As New Portal.BLL.LMUserAccess
        Dim count As Integer = 0
        Dim dtClientWise As DataTable = objUserAccess.GetLMRightsByUserID(CInt(Session("AdminID")))
