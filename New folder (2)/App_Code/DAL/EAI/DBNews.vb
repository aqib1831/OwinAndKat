...
Namespace Portal.DAL
    Public Class EAI_DBNews
#Region " Public Method "
        Public Shared Function NewsGetAll() As List(Of Portal.BLL.EAI_News)
            Dim colNews As New List(Of Portal.BLL.EAI_News)()
            ...
            While dr.Read()
                colNews.Add(New Portal.BLL.EAI_News( _
        ...
        Public Shared Function GetNewsByID(ByVal ID As Integer) As List(Of Portal.BLL.EAI_News)
            Dim colNews As New List(Of Portal.BLL.EAI_News)()
            Dim dr As SqlDataReader
            Dim objConnectionStringSettings As ConnectionStringSettings = ConfigurationManager.ConnectionStrings("FransupportConnectionString")
            Dim db As DBAccess = New DBAccess(objConnectionStringSettings.ConnectionString)
