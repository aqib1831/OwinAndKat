...
#Region " Public Method "
        ...
        Public Shared Function NewsGetAll() As List(Of FR_News)
            Return Portal.DAL.FR_News.NewsGetAll()
        End Function

        Public Shared Function GetNewsByID(ByVal ID As Integer) As List(Of FR_News)
            Return Portal.DAL.FR_News.GetNewsByID(ID)
        End Function
#End Region
