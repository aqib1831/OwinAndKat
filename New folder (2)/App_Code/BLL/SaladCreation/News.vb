...
#Region " Public Method "
        ...
        Public Shared Function NewsGetAll() As List(Of SC_News)
            Return Portal.DAL.SC_DBNews.NewsGetAll()
        End Function

        Public Shared Function GetNewsByID(ByVal ID As Integer) As List(Of SC_News)
            Return Portal.DAL.SC_DBNews.GetNewsByID(ID)
        End Function
#End Region
