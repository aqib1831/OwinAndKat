        ...
        If Not IsPostBack Then
            ...
            If String.IsNullOrEmpty(Request.QueryString("PrevPage")) = False AndAlso IsNumeric(Request.QueryString("PrevPage")) Then
                Select Case CInt(Request.QueryString("PrevPage"))
                    Case 4 'Tickets
                        btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/AreaDeveloper/PM/MyTickets.aspx?ddlClients=" & tktClient & "&ddlCategories=" & tktCatagory & "&ddlFilter=" & tktFilter & "&ddlTypes=" + tktTypes) & "'; return false; ")
                    Case 3 'MyTickets
                        btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/AreaDeveloper/PM/Tickets.aspx?ddlClients=" & tktClient & "&ddlCategories=" & tktCatagory & "&ddlFilter=" & tktFilter) & "'; return false; ")
                    Case 5 'Tickets History
                        btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/AreaDeveloper/PM/TicketsHistory.aspx?ddlClients=" & tktClient & "&ddlCategories=" & tktCatagory & "&ddlFilter=" & tktFilter) & "'; return false; ")
                    Case Else
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Page.IsValid Then
            ...
            With objTicketsBLL
                ...
                .RefNo = 0
                .AreaDeveloperId = Session("MyNetsolace_AreaDeveloperID")
