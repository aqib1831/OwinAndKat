...
Partial Class PM_Tickets
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Not String.IsNullOrEmpty(Request.QueryString("Pending")) Then
                ClientScript.RegisterStartupScript(Me.GetType(), "highLight", "<script language=javascript> parent.ChangeTrBackGround(8);</script>")
                odsRecentTickets.SelectParameters.Add("ClientStatusId", Request.QueryString("Pending"))
            Else
                ClientScript.RegisterStartupScript(Me.GetType(), "highLight", "<script language=javascript> parent.ChangeTrBackGround(3);</script>")
                odsRecentTickets.SelectParameters.Add("ClientStatusId", 0)
            End If
    ...
    Protected Sub gvReleases_Sorted(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvReleases.Sorted
        If gvReleases.SortDirection = SortDirection.Ascending Then
            hdnSortExpression.Value = gvReleases.SortExpression
        Else
            hdnSortExpression.Value = gvReleases.SortExpression & " DESC"
        End If
    End Sub
