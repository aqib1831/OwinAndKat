...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Dim HasTicketApprovalAccess As Boolean = DBClient_Contacts.GetTicketApprovalAccessByClientId(Session("Mynetsolace_ClientContactId"))
        'Dim MarkTicketForApproval As Boolean = DBClients.HasMarkTicketForApprovalByClientId(Session("Mynetsolace_ClientId"))

        'If HasTicketApprovalAccess And MarkTicketForApproval Then
        '    tr_eight.Attributes.Add("style", "display:inline")
        'Else
            tr_eight.Attributes.Add("style", "display:none")
        'End If
