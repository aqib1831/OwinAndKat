...
Partial Class PM_TicketsReport
    ...
    Private Sub LoadTicket()
        ...
        lblDueDate.Text = colTickets.Item(0).DueDate.ToShortDateString()
        If colTickets.Item(0).DueDateShowToClient = False Then
            lblDueDate.Text = "To be determined"
            lblDueDate.ToolTip = "To be determined"
        End If
        lblRequiredDate.Text = colTickets.Item(0).RequiredDate.ToShortDateString()
        ...
        Else
            ...
            tdrelease.Attributes.Add("style", "display:none;")
