...
<body style ="margin :0px; background-color:#E4F1F7; width:100%; height:100%;" onresize="AdjustHeight();">
    ...
    <table  style="height:100%; width:100%; " cellspacing="0" border="0"  >
                           ...
                           <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnSearch">
                               ...
                               <span>
                                   <asp:TextBox ID="txtSearch" runat="server" MaxLength="50" onkeyup="if(CheckNoisyWord()==false) return false;" onfocus="javascript:this.value='';"
                                       SkinID="GreenSmallTextbox"  Width="100px" style="vertical-align:top;"></asp:TextBox><asp:ImageButton ID="btnSearch" runat="server" OnClientClick="if(CheckNoisyWord()==false) return false;" ImageUrl="~/images/btn_go.gif" />
                               </span>
                           </asp:Panel>
                      </td>
                      <td style="width:50%;">
             ...
             <tr style="width:100%;">
               <td  colspan="2" style="background-color:#E4F1F7;  vertical-align:top; height: 85%; margin:0px;padding:0px;">
                    <div class="ScrollBarHomeTicket" id="_gridViewPanel1" >                   
                        ...
                        AllowSorting="True" DataKeyNames="ID" DataSourceID="ObjectDataSource1" PageSize="50" >
                         <PagerSettings Mode="Numeric" Position="Bottom" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DateCompleted" HeaderText="Date Completed" SortExpression="DateCompleted"  DataFormatString="{0:d}" HtmlEncode="False"  />
