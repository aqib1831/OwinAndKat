<%@ Page Language="VB" MasterPageFile="~/AreaDeveloper/MyNetsolace.master" AutoEventWireup="false" CodeFile="PMMain.aspx.vb" Inherits="PM_PMMain" title="Netsolace Portal-Project Managment" Theme="Default"  %>
<%@ Register Src="~/AreaDeveloper/PM/leftpanel_PM.ascx" TagName="ContactLeftPanel" TagPrefix="ucContactLeftPanel" %>
