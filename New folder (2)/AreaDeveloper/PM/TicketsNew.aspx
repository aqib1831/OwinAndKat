			  ...
			  <tr>
			   <td align="center" style="vertical-align:top; height:100%; width:100%;">
				   ...
				   <table border="0" cellpadding="1"  cellspacing="0" class="FormInnerTable" style="width:100%;  height:100%; text-align:left; vertical-align:top;" >
					   ...
					   <tr>
						   ...
						   <td>
                               ...
                               <asp:RegularExpressionValidator SetFocusOnError="true" ID="RegularExpressionValidator2"
                                   runat="server" Display="Dynamic" ControlToValidate="txtName" ValidationExpression="^[^<>]*$"
                                    ErrorMessage="<br />Special Characters are not allowed" ></asp:RegularExpressionValidator>
					   ...
					   <tr>
						   <td colspan="4" align="right" style="padding-right:5px;height:24px;">
					   ...
					   <tr  id="trFiles" style="display:none;border:none;">
						  ...
						  <td colspan="4" style="height:25px; background-color:White; border:1px solid #50AF43;">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td style="border:none;background-color:White;" rowspan="2" align="center" width="5%"><img id="Img2" runat="server" src="~/images/ico_attachment.gif" align="middle" alt="attach" /></td>
					   ...
					   <tr>
						   <td colspan="4" style="text-align:center; height:100%; padding-left:0px;">
                               ...
                               <asp:RegularExpressionValidator SetFocusOnError="true" ID="RegularExpressionValidator1"
                                                                                    runat="server" Display="Dynamic" ControlToValidate="txtDescription" ValidationExpression="^[^<>]*$"
