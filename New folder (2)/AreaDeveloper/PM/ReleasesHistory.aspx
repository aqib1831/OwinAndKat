<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReleasesHistory.aspx.vb" Inherits="PM_ReleasesHistory" Theme="Default"  %>
    ...
    <table width="100%" style="height:100%; width:100%; margin:0px; padding:0px;background-color:#E4F1F7; " cellspacing="0" cellpadding = "0" border="0"  >
             <tr class="UnderlinedRow">
                 <td  style="height:20px;background-color:#A0CDEE;font-size:12px;font-weight:bold;padding:5px;width:50%;">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                        <ContentTemplate>
                              Releases History&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;<asp:Label runat="server" ID="lblErrorCount" />
             ...
             <tr>
                <td colspan="2" style="height:40px;background-color:#BADCFC;font-size:11px;">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="white-space:nowrap;">
                    <tr>
                      <td style="padding:0px;text-align:left; display:none; white-space:nowrap; padding-right:0em; padding-top:13px;" >
             ...
             <tr>
               <td  colspan="2" style="background-color:#E4F1F7;margin:0px;padding:0px;">
                    <div style="overflow:auto;height:100%; width:100%; background-color:#E4F1F7;border:1px solid #ACBDD5;" id="_gridViewPanel1"  class="ScrollBarHomeTicket">
                         ...
                         <asp:GridView 
                            ...
                            <PagerSettings Mode="Numeric" Position="Bottom" />
                             <PagerTemplate>                                                
                                ...
                                <Columns>
                               <asp:TemplateField HeaderText="Releases" SortExpression="Name" >
                                    <ItemTemplate>
                                    <span title='<%#Eval("Name")%>' >
                                        <asp:Label ID="lblName" runat="server" style="font-weight:bold;" Text='<%# Server.HtmlEncode(Functions.StringTruncate(Functions.IfNull(Eval("Name"),""),39))%>' > ></asp:Label>
                                    </span>
                                    </ItemTemplate>
                                    <ItemStyle Width="310px"  Wrap="false" />
                                </asp:TemplateField>
                                    <asp:BoundField DataField="ReleaseDate" HeaderText="Release Date" SortExpression="ReleaseDate" DataFormatString="{0:d}" HtmlEncode="False" />                                    
                                   <asp:BoundField DataField="CategoryName" HeaderText="Category" SortExpression="CategoryName" />
                                    <asp:BoundField Visible="false"  DataField="ClientName" HeaderText="Client" SortExpression="ClientName" />                                                               
                      ...
                      <asp:ObjectDataSource ID="ObjectDataSource1"  
                            ...
                            SelectMethod="Releases_GetAllHistoryForMyNetsolace" 
                            TypeName="Portal.BLL.PM.PM_Releases" 
                            EnablePaging="true" 
                            SelectCountMethod="Releases_GetAllHistoryCountForMyNetsolace"
                            SortParameterName="sortExpression">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="ddlCategories" DefaultValue="1" Name="CategoryID"
                                    PropertyName="SelectedValue" Type="Int32" />
                                <asp:SessionParameter SessionField="MyNetsolace_ClientID"  DefaultValue="1" Name="ClientID" Type="Int32" />
             ...
             <tr style="height:20px; background-color:#BADCFC;">                
                ...
                <td align="left"  style="width:25%;white-space:nowrap;" class="GrayHeader">                    
                    ...
                    Delayed Releases are in Red Colors                                        
                </td>          
             </tr>           
         </table>
    </div>
