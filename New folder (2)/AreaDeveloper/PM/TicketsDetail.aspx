...
<head id="Head1" runat="server">
	...
	<style type="text/css">
		...
		#upContactsTable{height:100%;}
	</style>
</head>
<body style="margin:0px;width:100%;height:100%;" onresize="AdjustHeight();">
 <form id="form1" runat="server" >
    ...
    <asp:UpdateProgress ID="Progress1" runat="server">
      ...
      <table   style="width:100%;height:100%;background-color:#FFFFFF;" class="Table" border="0" align="center" cellpadding="0" cellspacing="0">
			   ...
			   <tr>
					<td style=" width:100%; height:100%; vertical-align:top;">
						<table id="DivRepeaterAndContacts" cellspacing="0" cellpadding="0" style="width:100%;height:100%;">
								...
								<td id="DivNotes" colspan="2" style="display: none;height:110px">
									<div  style="height:110px;padding:3px;padding-left:10px;width:100%;filter:progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#E7F7E1,endColorStr=#DEF7D6;);background-color:#DAF5D6; border-bottom:solid 1px #609BD3;">
										<table style=" width:100%; height:100px;" cellpadding="0" cellspacing="0" border="0" ondblclick="event.cancelBubble=true;">
                                                        <tr>
                                                            <td colspan="2" valign="middle" class="SimpleExSmallBold">Notes:</td>
                                                        </tr>
                                                        <tr>
							...
							<tr valign="top">
								<td style="width:100%;height:100%;">
								<div id="DivNotesDisplay"  runat="server" class="DivScroll" ondblclick="Notes();">
									 <asp:UpdatePanel ID="UpdatePanel2"
										 ...
										 <ContentTemplate>
                                             <asp:Repeater ID="rptrNotes" runat="server" DataSourceID="sdsNotes" EnableViewState="false">
                                                 <HeaderTemplate>
                                                     <table border="0" cellspacing="0" cellpadding="5" style="font-size: 11px; width: 100%;">
                                                 </HeaderTemplate>
                                                 <ItemTemplate>
                                                     <tr>
                                            ...
                                            <ItemTemplate>
	                                            <table cellpadding="5" cellspacing="0" border="0" style="font-size: 11px;width:98%;">
		                                            <tr>
			                                            <td>
								    ...
								    <table id="contactsTable" runat="server" cellspacing="0" cellpadding="0" style="width:200px;height:100%;">
											<tr valign="top">
												...
												<asp:Panel ID="pnlsearch" runat="server" DefaultButton="btnSearch">
													<div style="border-color:#F5F5F5; background-color:#DEF7D6; padding-top:3px; padding-left:7px; border-bottom:solid 1px white;" class="SimpleExSmallBold"><asp:TextBox ID="txtClientUserSearch" runat="server" Height="18" Width="140"  onkeyup='SearchUsers(this);' style="vertical-align:top;"></asp:TextBox>
													...
													<div style="border-color:#F5F5F5; background-color:#DEF7D6; height:20px; padding-bottom:1px;white-space:nowrap;padding-left:5px;" class="SimpleExSmallBold"><asp:Label ID="lblContactClientName" runat="server"></asp:Label>&nbsp;Contacts:
													</div> 
												</td>
											</tr>
         ...
         <tr style="background-color:#BDE7BD;height:35px;">
 ...
 <div id="fileUpload" style="display:none;">
     <div class="ProgressIndicatorDIVGreen">
         <br />
         <asp:Image ID="Image3" runat="server" ImageUrl="../../images/indicator.gif" ImageAlign="AbsMiddle" />
         <span style="color: #4B92C1; font-size: 14px;"><b>&nbsp;&nbsp;Uploading ...</b></span>
         <br />
         <br />
     </div>
 </div>
...
<script language="javascript" type="text/javascript">
    ...
    function AdjustHeight() {
        var client_height = $(window).height() - 120;
        $('#DivNotesDisplay').attr('style', 'height:' + client_height + 'px;overflow-y:scroll;width:100%;');
        client_height = client_height - 75;
        $('#DivContacts').attr('style', 'height:' + client_height + 'px;overflow-y:scroll;width:100%;');
    }	    	    
		   ...
		   if (DivNotes.style.display=='none')
				{
					...
					document.getElementById('<%=btnAddNotes.ClientID%>').textContent = 'Cancel';
					document.getElementById('<%=txtNotes.ClientID%>').value = '';
					document.getElementById('<%=txtNotes.ClientID%>').focus();
					var client_height = $(window).height() - 235;
					$('#DivNotesDisplay').attr('style', 'height:' + client_height + 'px;overflow-y:scroll;width:100%;');
					client_height = client_height - 75;
					$('#DivContacts').attr('style', 'height:' + client_height + 'px;overflow-y:scroll;width:100%;');
				}
			else
				{
					...
					document.getElementById('<%=btnAddNotes.ClientID%>').textContent = 'Add Notes';
