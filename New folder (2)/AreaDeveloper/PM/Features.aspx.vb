...
Partial Class PM_Features
            ...
            If HttpContext.Current.Request.QueryString("ID") <> String.Empty AndAlso IsNumeric(HttpContext.Current.Request.QueryString("ID")) Then
                ...
                If String.IsNullOrEmpty(Request.QueryString("PrevPage")) = False AndAlso IsNumeric(Request.QueryString("PrevPage")) Then
                    ...
                    Select Case PrevPage.Value
                        Case 1 'release page
                            btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/AreaDeveloper/PM/Releases.aspx?reClients=" & hdnClient.Value) & "&reCategories=" & hdnCatagory.Value & "'; return false; ")
                        ...
                        Case 2 'release history page
                            btnBack.Attributes.Add("OnClick", "window.location='" & ResolveClientUrl("~/AreaDeveloper/PM/ReleasesHistory.aspx?ddlClients=" & Session("MyNetsolace_ClientID")) & "&ddlCategories=" & ddlCategories.SelectedValue & "&reClients=" & hdnClient.Value & "&reCategories=" & hdnCatagory.Value & "'; return false; ")
    ...
    Protected Sub gvReleases_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvReleases.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            strStatus = CType(Functions.IfNull(DataBinder.Eval(e.Row.DataItem, "Status"), ""), String)
