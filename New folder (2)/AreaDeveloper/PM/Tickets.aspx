...
<body  style ="margin :0px;background-color:#E4F1F7;" onresize="AdjustHeight();" >
	...
	<table width="100%" style="height:100%; margin:0px; padding:0px;background-color:#E4F1F7;" cellspacing="0" cellpadding="0" border="0" id="tblTickets">
			 <tr>
			 <td colspan="2" style="height: 20px; ">
                 <table width="100%" style="height: 20px; margin: 0px; padding: 0px; background-color: #E4F1F7;"
                     ...
                     <tr class="UnderlinedRow" style="height:30px;">
                         <td style="background-color: #A0CDEE; font-size: 12px; font-weight: bold;
                             width: 40%;">
                             <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                 <ContentTemplate>
                                     <span style="font-family: Arial; font-size: 12px; font-weight: bold;
                                         padding-left: 3px;">Recent Tickets  |  <asp:Label runat="server" ID="lblErrorCount" />&nbsp;(<asp:Label
                                             runat="server" ID="lblFilter" Text="all" class="NonBold" />)</span>
                                 </ContentTemplate>
                                 <Triggers>
			 ...
			 <tr>
			   <td  colspan="2" style="background-color:#E4F1F7;margin:0px;padding:0px; vertical-align:top;">
					<div id="_gridViewPanel1"  class="ScrollBarHomeTicket">
								...
								<asp:TemplateField HeaderText="Ref #" SortExpression="RefNo">
								 ...
								 <asp:TemplateField HeaderText="Name" SortExpression="Name" HeaderStyle-Wrap="false" >
									...
									<span title='<%#Eval("Name")%>' >
										<%# Server.HtmlEncode(Functions.StringTruncate(Functions.IfNull(CType(Container.DataItem, Data.DataRowView)("Name"),""),30))%>
									</span>
									</ItemTemplate>
	...
	<script type="text/javascript" language="javascript">
	    ...
	    function OnRowClick(ReleaseID, ID) {
	        ...
	        QueryStringValues += "&Pending=" + <%= iif(String.isnullorEmpty(Request.QueryString("Pending")) = False,Request.QueryString("Pending"),0) %> + "&PrevPage=4"
