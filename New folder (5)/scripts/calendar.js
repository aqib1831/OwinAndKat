...
Calendar.addEvent = function(el, evname, func) {
	if (Calendar.is_ie)
		...
		else if (window.opera && el.addEventListener)
		...
		{
		if (window.opera && el.addEventListener)
			el.addEventListener(evname, func, false);
		else if (addEventListener)
			el.addEventListener(evname, func, true);
		}
...
Calendar.prototype.showAt = function (x, y) {
	...
	var cL = this.element.offsetLeft;
	var cT = this.element.offsetTop;
	var pW = document.body.clientWidth;
	var pH = document.body.clientHeight;
	var pL = document.body.scrollLeft;
...
Date.prototype.print = function (frm) {
	...
	var re = /(.*)(\W|^)(d|dd|M|MM|y|yy|yyyy|ddd|dddd|MMM|MMMM|w|ww)(\W|$)(.*)/;
