...
<%@ Register Src="~/Reports/LeftPanel_Reports.ascx"TagName="leftPanelLM" TagPrefix="LM" %>
...
<table border="0" cellpadding="0" cellspacing="0"  style="height:100%;width:100%;background-color:#E4F1F7;">
  <tr>              
    ...
    <td align="center" style="vertical-align:top; border:1px solid #609BD3;">        
        <iframe id="iframeMain" frameborder="0" marginheight="0" marginwidth="0" src="SMSXLicenseManagement.aspx" scrolling="no" width="100%" height="100%"></iframe>
    </td>
  </tr>
</table>
</asp:Content>
