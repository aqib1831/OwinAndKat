<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Users_ChangePassword.aspx.vb" Inherits="Users_ChangePassword" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;height:100%;background-color:#DDEEFE;font-size:12px;color:#73797F;">
                                                                        ...
                                                                        <tr>
                                                                            <td style="height:25px;padding-left:2em;text-align:left; width:40%;">Email Address:</td>
                                                                            <td style="text-align:left;width:60%;">
                                                                               <b><asp:Label ID="lblEmailAddress" runat="server" Text=""></asp:Label></b> 
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                    ...
                    <tr>
                        <td style="height:24px;background:url('images/ftr_bg.jpg');">
                            <table width="100%"  border="0" cellpadding="0" cellspacing="0" style="height:24px;" class="WhiteSmall">
                              <tr>
                                <td style="height: 24px">&nbsp;&nbsp;Copyright &copy; <%= Year(Now) %>, Netsolace, Inc.&nbsp;&nbsp;&nbsp;</td>
