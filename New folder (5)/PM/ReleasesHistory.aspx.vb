...
Partial Class PM_ReleasesHistory
    ...
    Protected Sub gvReleases_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvReleases.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(0).Attributes.Add("onClick", "javascript:window.location='Features.aspx?ID=" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & "&reClients=" & ddlClients.SelectedValue.ToString() & "&reCategories=" & ddlCategories.SelectedValue.ToString() & "&PrevPage=2';")
            e.Row.Cells(1).Attributes.Add("onClick", "javascript:window.location='Features.aspx?ID=" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & "&reClients=" & ddlClients.SelectedValue.ToString() & "&reCategories=" & ddlCategories.SelectedValue.ToString() & "&PrevPage=2';")
            e.Row.Cells(2).Attributes.Add("onClick", "javascript:window.location='Features.aspx?ID=" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & "&reClients=" & ddlClients.SelectedValue.ToString() & "&reCategories=" & ddlCategories.SelectedValue.ToString() & "&PrevPage=2';")
            e.Row.Cells(3).Attributes.Add("onClick", "javascript:window.location='Features.aspx?ID=" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & "&reClients=" & ddlClients.SelectedValue.ToString() & "&reCategories=" & ddlCategories.SelectedValue.ToString() & "&PrevPage=2';")
            e.Row.Cells(4).Attributes.Add("onClick", "javascript:window.location='Features.aspx?ID=" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & "&reClients=" & ddlClients.SelectedValue.ToString() & "&reCategories=" & ddlCategories.SelectedValue.ToString() & "&PrevPage=2';")
            e.Row.Cells(5).Attributes.Add("onClick", "javascript:window.location='Features.aspx?ID=" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), String) & "&reClients=" & ddlClients.SelectedValue.ToString() & "&reCategories=" & ddlCategories.SelectedValue.ToString() & "&PrevPage=2';")
    ...
    Protected Sub gvReleases_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvReleases.RowCommand
        If e.CommandName <> "Sort" And e.CommandName <> "Page" Then
            ...
            ElseIf e.CommandName = "Features" Then
                Response.Redirect("Features.aspx?ID=" & ID & "&reClients=" & ddlClients.SelectedValue.ToString() & "&reCategories=" & ddlCategories.SelectedValue.ToString() & "&PrevPage=2")
            End If
        End If
