...
Partial Class com_VitalInformationFloatingDiv
    ...
    Protected Sub GridView2_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        e.Row.Cells(0).ToolTip = DataBinder.Eval(e.Row.DataItem, "Title")
    End Sub


    Protected Sub sdsProjectInformation_Selected(sender As Object, e As ObjectDataSourceStatusEventArgs)
        'Dim objret As String = e.
        'Dim w As List(Of KeyValuePair(Of String, String)) = sdsProjectInformation.Select()
        'CType(w, List(Of KeyValuePair(Of String, String))
