<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FeaturesNew.aspx.vb" Inherits="PM_FeaturesNew" Theme="Default" ValidateRequest="false"  %>
			   ...
			   <td align="center" style="vertical-align:top; height:100%; width:100%;">
				   ...
				   <table border="0" cellpadding="1"  cellspacing="0" class="FormInnerTable" style="width:100%;height:100%;">
					   ...
					   <tr>
						   ...
						   <td style="padding-left:15px;">
								Releases:<span style="color: #ff0000">*</span>
						   </td>
						   <td align="left">
						   ...
						   <asp:DropDownList ID="ddlReleases" runat="server" DataSourceID="SDS_Releases"
									AutoPostBack="true"  DataTextField="Name" DataValueField="ID" SkinID="SmallTextCombo" Width="200px">
						   </asp:DropDownList>
							   <asp:SqlDataSource ID="SDS_Releases" 
								   ...
								   <SelectParameters>
									   <asp:ControlParameter DefaultValue="" ControlID="hdnClientID" Name="ClientID" Type="Int32" />
								   </SelectParameters>
							   </asp:SqlDataSource>
							   <asp:CompareValidator ID="CV_Releases" runat="server" ControlToValidate="ddlReleases"
								   Display="Dynamic" ErrorMessage="<br/>Please Select Releases" Operator="GreaterThan"
					   ...
					   <tr>
						   ...
						   <td style="text-align: left"><asp:DropDownList ID="ddlTypes" runat="server" DataSourceID="SDS_Type"
									DataTextField="Name" DataValueField="ID" SkinID="SmallTextCombo" Width="200px">
							</asp:DropDownList>
							<asp:SqlDataSource ID="SDS_Type" 
								runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
								SelectCommand="PM_TaskTypes_GetAll_New" 
								SelectCommandType="StoredProcedure"
								DataSourceMode="DataReader">
							</asp:SqlDataSource>
						   ...
						   <td style="padding-left:15px;">
							   Status:<span style="color: #ff0000">*</span></td>
						   <td align="left">
							   <asp:DropDownList ID="ddlStatus" runat="server" SkinID="SmallTextCombo" Width="200px">
							   </asp:DropDownList>
					   ...
					   <tr>
						   ...
						   <td style="text-align: left">
							   ...
							   <img id="imgDDCalander" align="absMiddle"  border="0" onclick="setActiveStyleSheet(this, 'winter'); return showCalendar('<%= txtDueDate.ClientID %>', '<%=System.Globalization.DateTimeFormatInfo.CurrentInfo.ShortDatePattern %>');"
								   ...
								   <asp:RequiredFieldValidator  ID="RFV_DueDate" runat="server" ControlToValidate="txtDueDate" Display="Dynamic"
									   ErrorMessage="<br/>Please Enter Feature Due Date" SkinID="RequiredFieldValidation"></asp:RequiredFieldValidator>
								 ...
								 <asp:CompareValidator ID="CV_FutureDate" Display="Dynamic" runat="server" ControlToValidate="txtDueDate" type="Date"  Operator="GreaterThanEqual" 
					   ...
					   <tr>
						   <td align="center"  colspan="4" style="text-align:center;height:100%;">
...
function CheckReleaseDueDate()
{
	 ...
	 var txtDueDate = new Date(document.getElementById('<%=txtDueDate.ClientID %>').value)
	 var strmsg = '';
	 var bool = 0;
