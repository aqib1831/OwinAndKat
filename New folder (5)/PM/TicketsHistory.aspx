...
<body style ="margin :0px; background-color:#E4F1F7; width:100%; height:100%; ">
               ...
               <td  colspan="2" style="background-color:#E4F1F7;  vertical-align:top; height: 85%; margin:0px;padding:0px;">              
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" 
                     ...
                     <ContentTemplate>
                        ...
                        AllowSorting="True" DataKeyNames="ID" DataSourceID="odsTicketHistory" PageSize="50" >
                         <PagerSettings Mode="Numeric" Position="Bottom" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Date Completed" SortExpression="DateCompleted">
                                    <ItemTemplate>                                    
                                        <%#Functions.FormatShortDate(CType(Container.DataItem, Data.DataRowView)("DateCompleted"))%>
                                    </ItemTemplate>
                                    <ItemStyle Width="15%"/>
                                </asp:TemplateField>
                        ...
                        <asp:ObjectDataSource ID="odsTicketHistory" 
                            runat="server" 
                            SortParameterName="SortExpression"
                            SelectMethod="PM_TicketGetAllHistory"
                            EnablePaging="true"
                            StartRowIndexParameterName="StartRowIndex"
                            MaximumRowsParameterName="MaximumRows"
                            SelectCountMethod="PM_TicketGetAllHistoryCount" 
   ...
   function AdjustPagerRow()
   {
    ...
    function OnRowClick(ReleaseID, ID) {
            window.location = "TicketsDetail.aspx?ReleaseID=" + ReleaseID + "&ID=" + ID 
                            + "&ddlClients=" + document.getElementById('<%=ddlClients.ClientID %>').value
