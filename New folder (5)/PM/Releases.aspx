           ...
           <asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="300"  />
             ...
             <table width="100%" style="height:100%; width:100%; margin:0px; padding:0px;background-color:#E4F1F7; " cellspacing="0" cellpadding = "0" border="0"  >
               <tr class="UnderlinedRow">
                ...
                <td style="background-color:#A0CDEE;font-size:12px;font-weight:bold;padding:3px;color:#437494;text-align:right;height: 1px;">
                    &nbsp;&nbsp;
                     &nbsp;&nbsp;
                     ...
                     <img  align="absmiddle" src="../images/pixel_skyBlue.jpg" width="1" height="20" alt="" />                    
                </td>                        
              </tr>              
              <tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="white-space:nowrap;">
                    <tr>
                      <td style="padding:5px;text-align:left ; white-space:nowrap; padding-right:1em; padding-top:13px;" >
                        <div  id="divNewRelease" runat="server" style="width:100px;" class="LeadDetailButton" onclick="javascript:StateSaveNewRelease();"  >
                          NEW RELEASE
                                ...
                                <Columns>
                                   <asp:TemplateField HeaderText="Releases" SortExpression="Name" HeaderStyle-Wrap="false" >
                                            ...
                                            <span style="width:10px; text-align:left;"><img  src="../images/pm_flag.gif" style='<%#  IIf(IIf(Eval("NewReleaseDate") <> "1/1/1900",Eval("NewReleaseDate"),Eval("ReleaseDate")) <= DateTime.Now.Date, "display:inline", "display:none") %>;'  /></span>
                                                <%--<span style="width:10px; text-align:left;"><img  src="../images/pm_flag.gif" style='<%#  IIf(IIf(Eval("SowSignedDate") <> "1/1/1900",Eval("SowSignedDate"),Eval("ReleaseDate")) <= DateTime.Now.Date, "display:inline", "display:none") %>;'  /></span>--%>
                                            <span title='<%#Eval("Name")%>' style='<%# IIf(Eval("NewReleaseDate") <= DateTime.Now.Date, "padding-left:0px;", "padding-left:10px;") %>'>
                                                <asp:Label ID="lblName" runat="server" style="font-weight:bold;" Text='<%# Server.HtmlEncode(Functions.StringTruncate(Functions.IfNull(Eval("Name"), ""), 50))%>' > ></asp:Label>
                                            </span>
                                            </ItemTemplate>
                                            <ItemStyle Width="350px"  Wrap="false" />
                                    </asp:TemplateField>
                      
                                    <asp:BoundField  DataField="ReleaseDate" HeaderText="Rel Date" SortExpression="ReleaseDate" DataFormatString="{0:d}" HtmlEncode="False" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" ></asp:BoundField>
                                    <asp:BoundField  DataField="NewReleaseDate" HeaderText="New Date" SortExpression="NewReleaseDate" DataFormatString="{0:d}" HtmlEncode="False" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" />
                                    ...
                                    <asp:BoundField DataField="ClientName" HeaderText="Client" SortExpression="ClientName" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" />
                                    <asp:TemplateField Headertext="Progress" HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                                        <ItemTemplate >
                                        <table width="100%" cellpadding="0" border="0" cellspacing="0" >
                                            <tr valign="middle">
                                                <td style="width:35px; border-bottom:0px;">
                                     ...
                                     <asp:TemplateField  ItemStyle-Width="5px" HeaderText="Status" SortExpression="Status" HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                                    <ItemTemplate> 
   ...
   function AdjustPagerRow()
   {
    ...
    function SetPosition()
    {
     ...
     var DivFram = getElement('<%= DivIFrame.ClientID %>')  
        ...
        getElement('<%= ddlClients.ClientID %>').style.display = "none"
    ...
    lblNotes.innerText = ''
        ...
        getElement('<%= ddlClients.ClientID %>').style.display= "inline"
        ...
        { 
          ...
          var InputStr = document.getElementById('<%= txtsearch.ClientID %>').value;
           ...
           function OnRowClick(ID) {
           	...
           	QueryStringValues += "&reClients=" + document.getElementById('<%=ddlClients.ClientID %>').value;
           ...
           //    var url = "../ExcelGenerator.ashx?Action=ExportPMCurrentReleases&ClientId=" + ClientId + "&CategoryId=" + CategoryId + "&ClientName=" + ClientName + "&CategoryName=" + CategoryName + "&UserLogID=" + UserLogID + "&searchtxt=" + searchtxt + "&nocache=" + uniqueid;
           //    window.open(url);
