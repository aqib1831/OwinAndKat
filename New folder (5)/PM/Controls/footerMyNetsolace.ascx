...
<table cellpadding="0" width="0" cellspacing="0" border="0" style="background-image:url('../images/ftr_bg.jpg'); height:24px; width:100%;" class="WhiteSmall">
    <tr>
        ...
        <td align="right" style="width:187px;height:24px;cursor:pointer;" onclick="window.open('http://qa.netsolace.com');"><img src="../images/logo_ftr_netsolace.jpg" Width="187" Height="24" /></td>
    </tr>
</table>
</div>
