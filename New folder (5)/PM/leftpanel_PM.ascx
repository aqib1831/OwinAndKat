...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" style="border:solid 0px #EEEDE5; height:100%; display:table-row;"  bgcolor="#D8EAFC">
     ...
     <tr onclick="javascript:RedirectPage(2);"  runat="server" id="tr_Two" class="Calendar_Normal">
        ...
        <td colspan="2"  align="left" title="Click to View Recent Tickets" >
            &nbsp;<a href="#">Recent Tickets &amp; Features</a>
        </td>
     </tr>
     ...
     <tr onclick="javascript:RedirectPage(8);"  runat="server" id="tr_eight" class="Calendar_Normal">
        <td align="center" style="width: 10px"  >
            <div width="17" runat="server" id="div6" height="31" align="center" />
        </td>
        <td colspan="2"  align="left" title="Click to View PM Reports" >
            &nbsp;<a href="#">My Reports &nbsp;</a>
        </td>
     </tr>
</table>
   ...
   function RedirectPage(Page)   
    {
                ...
                {                            
                   IfPM.location='ReleasesNew.aspx';
                    ...
                    IfPM.location = 'MyPMReports.aspx';    
                }
    }
