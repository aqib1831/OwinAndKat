<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CreateReport.aspx.vb" Inherits="PM_CreateReport" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 100%; height: 100%; background-color: #E1F8DB">
            <tr style="height: 5%; background-color: #C4E8C7; border: 1px solid #9DB7D0; vertical-align: top;">
                <td colspan="4" style="height: 40px; border: 1px solid #9DB7D0; vertical-align: middle; padding-left: 10px;">Create New Report
                </td>
            </tr>
            <tr>
                        ...
                        <table style="width: 100%; border-collapse: collapse">
                            ...
                            <tr class="border_bottom" style="height: 45px;">
                                <td colspan="2" style="padding-left: 40px; font-size: 12px;">Report Name:
                                    <asp:TextBox ID="txtReportName" MaxLength="30" runat="server"></asp:TextBox><br />
                                            ...
                                            <tr>
                                                <td align="left" class="DropDownLook">
                                                    ...
                                                    <div style="width: 50%;">
                                                        ...
                                                        <div runat="server" id="div5" class="DivCheckBoxList" style="width: 150px; height: 300px;">
