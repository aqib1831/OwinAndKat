<%@ Page Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="PMMain.aspx.vb" Inherits="PM_PMMain" title="Netsolace Portal-Project Management" Theme="Default"  %>
...
<table border="0" cellpadding="3" cellspacing="0" width="100%" style="height:100%;background-color:#E4F1F7;padding:4px;" id="tblLeftPanel">
  <tr>              
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#D8EAFC;height:100%;border:1px solid #609BD3;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="filter:progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#D8EAFC,endColorStr=#A0CDEE);background: -webkit-gradient(linear, center top, center bottom, from(#D8EAFC), to(#A0CDEE));background: -moz-linear-gradient(#D8EAFC, #A0CDEE);">
                            ...
                            <tr>
                                <td style="height:20px;font-size:11px;padding-left:5px;padding-bottom:3px;">
                                    <asp:TextBox runat="server" ID="txtSearch" CssClass="GreyTextBox" onfocus="javascript:this.value='';"  MaxLength="50" Width="85%" onkeyup="if(CheckNoisyWord()==false) return false;"   AutoCompleteType="Disabled" ValidationGroup="searchticket" />
        ...
        <tr >
            ...
            <div id="div1" runat="server">            
				<asp:Repeater
					runat="server" ID="rptStores" DataSourceID="">
						<HeaderTemplate>
							<table class="SearchTbl" border="0" cellpadding="0" cellspacing="0" id="tblSearchResults">
						</HeaderTemplate>
                        <ItemTemplate>
							<tr onmousemove="showToolTip(this,'<%#Server.HtmlEncode(Functions.StringTruncate(Functions.IfNull(Eval("UserName"),""),25)) & "','" & Eval("TypeName")& "','" & Eval("Status") & "','" & Eval("CatagoryName")& "','" & Eval("DueDate")& "','" & Eval("ReleaseName") %>');" onmouseout="OnOut(this);" onclick="OnClick('<%#Eval("ReleaseID")%>','<%#Eval("ID")%>');">
    ...
    <td align="center" style="padding-left:0; vertical-align:top;">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin :0px; background-color:white;height:100%;border:1px solid #609BD3;">
        <tr>
