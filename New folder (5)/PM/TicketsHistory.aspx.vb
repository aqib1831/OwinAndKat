Partial Class PM_TicketsHistory
    ...
    Protected Sub gvReleases_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvReleases.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Attributes.Add("onClick", "javascript:window.location='TicketsDetail.aspx?ReleaseID=" & DataBinder.Eval(e.Row.DataItem, "ReleaseID") & "&ID=" & CType(DataBinder.Eval(e.Row.DataItem, "ID"), Integer) & "&ddlClients=" & ddlClients.SelectedValue.ToString() & "&ddlCategories=" & ddlCategories.SelectedValue.ToString() & "&ddlTypes=" & ddlTypes.SelectedValue.ToString() & "&ddlFilter=" & ddlFilter.SelectedValue.ToString() & "&txtSearch=" & txtSearch.Text.ToString() & "&hdnSortBy=" & hdnSortBy.Value & "&PrevPage=5';")
    ...
    Protected Sub gvReleases_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvReleases.RowCommand
        If e.CommandName <> "Sort" And e.CommandName <> "Page" Then
            ...
            If e.CommandName = "View" Then
                Response.Redirect("TicketsDetail.aspx?ID=" & ID & "&ddlClients=" & ddlClients.SelectedValue.ToString() & "&ddlCategories=" & ddlCategories.SelectedValue.ToString() & "&ddlTypes=" & ddlTypes.SelectedValue.ToString() & "&ddlFilter=" & ddlFilter.SelectedValue.ToString() & "&txtSearch=" & txtSearch.Text & "&hdnSortBy=" & hdnSortBy.Value & "&PrevPage=5")
            End If
        End If
        '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Protected Sub gvReleases_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvReleases.RowCreated
        ...
        End If
    End Sub
    Protected Sub odsTicketHistory_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles odsTicketHistory.Selected
