...
<body style="background-color:#E4F2F5;height:100%;overflow:auto;padding:0;margin:0;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;height:100%;background-color:#DDEEFE;font-size:12px;color:#73797F;">
                                                                        ...
                                                                        <tr>
                                                                <td style="height: 25px; text-align: left; width: 40%;">
                                                                    <asp:Label ID="lblPassword" runat="server" Text="Old Password:"></asp:Label> </td>
                                                                        ...
                                                                        <tr>
                                                                <td style="height: 25px; text-align: left;">	 New Password: </td>
                                                                        ...
                                                                        <tr>
                                                                <td style="height: 25px; text-align: left;">	  Confirm Password:	 </td>
                                                                            <td style="text-align:left;">
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2" style="text-align:center;height:25px;" >
                                                                                 ...
                                                                                 <asp:Button runat="server" ID="btnCancel" Text="Close" PostBackUrl="~/Home.aspx" CssClass="Btn3D" CausesValidation="false"  />
                                                                            </td>
                                                                        </tr>
                                                                        <tr><td colspan="2"></td></tr>
                                                                    </table>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function CheckNewPasswordFormat(src, args){
            var hdnvalue = getElement('<%= hdnType.ClientID %>');
            var hdnTempvalue = getElement('<%= hdnTemp.ClientID %>');
                    ...
                    {                   
                        ...
                        {                             
                            if ( npass.value != cpass.value)
                            {
                                ...
                                else if (hdnTempvalue.value != '') {
                                    trError.style.display = 'inline';
                                    spnError.innerHTML = 'Temporary and new password must not match.';
                                }
                                else {
                                    trError.style.display = 'inline';
                                    spnError.innerHTML = 'Old and new password must not match.';
