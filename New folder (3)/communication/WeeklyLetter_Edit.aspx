<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WeeklyLetter_Edit.aspx.vb" Inherits="admin_comm_WeeklyLetter_Edit" %>
<html>
<head id="Head1" runat="server">
    <title>Edit WeeklyLetter</title>
...
<body style=" margin:0px; padding:0px; border:0px;height:100%;background-color: #daf5d6;" scroll="No">
        ...
        <table border="0" cellpadding="5" cellspacing="0" style="width:100%;height:100%;">
            <tr class="HeaderRowGreen">
                <td style="height:30px;border-bottom:#609bd3 1px solid;"> 
                    &nbsp;<asp:Label ID="lblHeading" runat="server" Font-Bold="True" Font-Size="12px" Text="Edit Weekly Letter"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr class="HeaderRowGreen">
                ...
                <asp:Button ID="btnUpdate" runat="server" OnClick="btnUpdate_Click" CssClass="Btn3D"  Text="Update"/>&nbsp;
                 <input id="btnCancel" class="Btn3D" onclick="RedirectToPage();" type="button" value="Cancel" />
    ...
    function RedirectToPage(){
        window.location='EAWeeklyLetters.aspx?<%= Request.Querystring().ToString() %>';
    }
    </script>
    </form>
</body>
