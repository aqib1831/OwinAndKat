...
Partial Class admin_comm_WeeklyLetterTemplates_Template_2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        hdnForumID = FormView1.FindControl("hdnForumID")
        ...
        If CType(hdnStatus.Value, Boolean) = False Then
            ...
            ltl = FormView1.FindControl("ltlForumEdit")
            If ltl IsNot Nothing Then
                ltl.Text = "&nbsp;<a href='#' onclick="" parent.location='WeeklyLetter_update.aspx?Forum=1&id=" & hdnForumID.Value & "&LetterID=" & hdnLetterID.Value & "';""><font color='#FFFFFF' face='Arial, Helvetica, sans-serif'><b>Edit</b></font></a>"
            End If
        Else
