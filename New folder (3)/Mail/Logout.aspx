<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Logout.aspx.vb" Inherits="Mail_Logout" %>
...
<body style="background-color:#E4F2F5;height:100%;overflow:auto;padding:0;margin:0;" onload= "setTimeout('window.close()',3000)"> 
<form id="frmLogout" runat="server"  style="height:100%;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="width:100%;height:100%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align:left; width:73%;">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:400px;height:100px;">
                                        <tr>
                                        ...
                                        <tr id="trErrorMessage" runat="server" visible="false">
                                            ...
                                            <td style="height:35px;text-align:center;background-color:#DDEEFE;color:#BA0300;">&nbsp;&nbsp;&nbsp;<b><span id='spnError' runat="server"></span></b></td>
                                            ...
                                            <td>
                                                <table id="tblForm" runat="server" cellpadding="0" cellspacing="0" border="0" style="width:100%;height:100%;background-color:#DDEEFE;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:400px;text-align:center;font-size:18px;color:#383C3C;"><img  src="../images/icn_err.gif" align="absmiddle" />&nbsp;&nbsp;<asp:Label ID="lblMsg" runat="server"></asp:Label> 
                                                        </td>
                                                        <td style="width:30px;"></td>
                                                    </tr>
                                                    <tr>
