<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NewLegalActivity.aspx.vb"
    Inherits="admin_Legal_NewLegalActivity" Theme="Default" %>
...
<head runat="server">
    ...
    <link href="../style/Calendar/style.css" type="text/css" rel="stylesheet" />
      <script type="text/javascript" language="JScript" src="../scripts/functions.js"></script>
 ...
 function chkStatus()
    {
        ...
        if(status==4)
        {
           document.getElementById("TDWait").style.display='inline';
        }
        else
        {
        ...
        <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0"
            ...
            <tr class="UnderlinedRow" style="cursor: default; background-color: #BDE7BD;">
                <td style="height: 31px; border-bottom: Solid 1px White;padding-left:2px;font-size:14px;">
                    <strong>&nbsp;New Activity <span style="display:none;">(<asp:Label ID="lblIPName" runat="server"></asp:Label>
                            ...
                            SelectCommand="SELECT * FROM [Legal_IPActivityTypes] WHERE [Deleted] = 0">
                        </asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                    ...
                    <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="height: 15px;">
                            ...
                            <td align="left" style="border-bottom: white 1px solid;width:33%;">
                                <input type="text" name="txtTime" readonly id="txtTime" value='<%=FormatDateTime(DateTime.Now.TimeOfDay.ToString()) %>'
                                    class="MediumGreenTextBox" maxlength="8" style="width: 115px"></td>
                        ...
                        <tr>
                            ...
                            <td style="border-bottom: white 1px solid">
                                <asp:DropDownList Width="42" ID="ddlHoursNotes" runat="server" AutoPostBack="false"
                                    CssClass="MediumFontInput">
                                ...
                                &nbsp;&nbsp;:&nbsp;&nbsp;
                                <asp:DropDownList Width="42" ID="ddlMinutesNotes" runat="server" AutoPostBack="false"
                                    CssClass="MediumFontInput">
                                    <asp:ListItem Selected="True" Text="00" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="01" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="02" Value="2"></asp:ListItem>
                            ...
                            <td style="border-bottom: white 1px solid;">
                                <asp:DropDownList ID="ddlActivityAssginedTo" runat="server" AppendDataBoundItems="True"
                                    ...
                                    CssClass="MediumFontInput"><asp:ListItem Value="-1">Choose...</asp:ListItem></asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="border-bottom: white 1px solid">
                                <asp:TextBox ID="txtSubject" runat="server" CssClass="MediumGreenTextBox" MaxLength="70" Width="100%"></asp:TextBox></td>
                            <td style="border-bottom: white 1px solid; padding-left: 15px;">
                                <input type="button" id="btnAttach" name="btnAttach" value="Attach File" style="width: 80px;"
                                        ...
                                        <td style="height: 15px;width:300px;" valign="middle">
                                            ...
                                            <td >
                                             <asp:DropDownList ID="ddlActivityState" runat="server" CssClass="MediumFontInput"
                                                onchange="chkStatus();" Width="95px"><asp:ListItem Value="-1">Choose...</asp:ListItem><asp:ListItem Value="1">Not Started</asp:ListItem><asp:ListItem Value="2">In Progress</asp:ListItem><asp:ListItem Value="3">Complete</asp:ListItem><asp:ListItem Value="4">Waiting For</asp:ListItem></asp:DropDownList>
                                             <asp:RequiredFieldValidator
                                                SetFocusOnError="true" 
                                            ...
                                            <td id="TDWait">
                                            <asp:DropDownList ID="ddlAssignedTo" runat="server" CssClass="MediumFontInput" Width="115px"
...
<%--                                            <td>&nbsp;
                                        ...
                                        <td>
                                            <table id="tdReminder" border="0" cellpadding="0" cellspacing="0" height="28" width="250">
                                                <tr>
                                                    <td style="width: 1px">
                                                        <img src="../images/pixel_green.JPG" height="23" width="1" align="absmiddle" /></td>
                                                    <td id="tdRemChk" style="border-top-style: none; border-right-style: none; border-left-style: none;
                                                        border-bottom-style: none; padding-left: 5px;">
                                                        <asp:CheckBox ID="chkReminder" runat="server" CausesValidation="True" Font-Size="X-Small"
                                                            Height="16px" onclick="showReminder();" Text="Reminder" Width="80px" /></td>
                                                    <td id="tdDate" style="width: 72px; border-top-style: none; border-right-style: none;
                                                        ...
                                                        <asp:TextBox CssClass="MediumGreenTextBox" ID="txtReminderDate" runat="server" CausesValidation="True"
                                                            onfocus="this.blur();" Width="70px"></asp:TextBox>
                                                    </td>
                                                    <td id="tdCalender" style="border-top-style: none; border-right-style: none; border-left-style: none;
                                                        ...
                                                        <asp:ImageButton align="absmiddle" ID="imgCalender" runat="server" Height="16px"
                                                            ImageUrl="~/images/icn_calendar.png" OnClientClick="setActiveStyleSheet(this, 'calstyle'); return showCalendar('txtReminderDate', 'MM/dd/y');"
                                                            Width="16px" /></td>
                                        ...
                                        <td align="right" style="height: 30px; padding-right:10px;" valign="middle">
                                            ...
                                            &nbsp;<input type="button" value="Cancel" onclick="parent.frameMain.location='IPMain.aspx?ID=<%=Request.QueryString("ID") %>'"
                                                title="Cancel" class="Btn" style="width: 70px;">&nbsp;
                                ...
                                <asp:SqlDataSource ID="AdminsDS" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
                                    SelectCommand="admin_GetForList" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
