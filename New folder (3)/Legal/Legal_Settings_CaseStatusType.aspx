<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Legal_Settings_CaseStatusType.aspx.vb" Inherits="admin_Legal_Settings" Theme="Default" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" height="100%" style="width: 100%;"
                            ...
                            <tr>
                                <td style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px; padding-top: 5px;
                                    ...
                                    <strong>Case Status Types&nbsp; </strong>
                                        ...
                                        <asp:UpdatePanel ID="UPTypes" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="gridCaseStatusType" runat="server" AutoGenerateColumns="False"
                                                    DataKeyNames="ID" DataSourceID="odsCaseStatusType" OnRowCommand="gridCaseStatusType_RowCommand"
                                                    OnRowDataBound="gridCaseStatusType_RowDataBound" SkinID="GridViewNoPaging"  AllowPaging="false" Width="100%">
                                                    <EmptyDataTemplate>
                                                        ...
                                                        <asp:TemplateField ShowHeader="False">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" CommandArgument='<%#Eval("ID")%>'
                                                                    CommandName="Delete" OnClientClick="javascript:event.cancelBubble=true;return confirm('Are you sure you want to delete this Case Status Type?');"
                                                                    Text="Delete"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:ObjectDataSource ID="odsCaseStatusType" runat="server" DeleteMethod="DeleteCaseStatusType"
                                                    SelectMethod="GetCaseStatusTypes" TypeName="CaseMgmt" UpdateMethod="UpdateCaseStatusTypes">
                                                    <UpdateParameters>
                                                        ...
                                                        <table id="tblSearch" border="0" cellpadding="0" cellspacing="0" height="150" style="display: inline;
                                                            ...
                                                            <tr>
                                                                <td height="28" style="font-weight: bold; font-size: 12px; background-image: url(images/bg_CellNormal_black.jpg);
                                                                    ...
                                                                    &nbsp;New Case Status Type<span id="edit" style="display: none;">&nbsp;<asp:Label
