<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Legal_Settings_IPStatusType.aspx.vb" Inherits="admin_Legal_Settings" Theme="Default" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" height="242" style="width: 100%;
                            ...
                            <tr>
                                <td style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px; padding-top: 5px;
                                    ...
                                    <strong>Intellectual Property Status Types</strong>&nbsp;
                                ...
                                <td colspan="3" style="width: 100%" valign="top">
                                    <div style="overflow-y: auto; height: 100%; background-color: white">
                                        <asp:UpdatePanel ID="UPTypes" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="gridIPStatusType" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                                    DataSourceID="odsIPStatusType" Width="100%" OnRowCommand="GridIPStatusType_RowCommand" OnRowDataBound="gridIPStatusType_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Name">
                                                            <EditItemTemplate>
                                                                <asp:TextBox ID="txtIPStatusType" runat="server" MaxLength="25" Text='<%# Bind("Name") %>'></asp:TextBox>
                                                                <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvIPStatusType" runat="server"
                                                                    ControlToValidate="txtIPStatusType" CssClass="requiredfield" Display="Static"
                                                        ...
                                                        <asp:TemplateField ShowHeader="False">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" CommandArgument='<%#Eval("ID")%>'
                                                                    CommandName="Delete" OnClientClick="javascript:event.cancelBubble=true;return confirm('Are you sure you want to delete this IP Status Type?');"
                                                                    Text="Delete"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:ObjectDataSource ID="odsIPStatusType" runat="server" DeleteMethod="DeleteIPStatusType"
                                                    SelectMethod="GetIPStatusTypes" TypeName="IntellectualProperty" UpdateMethod="UpdateIPStatusType">
                                                    <UpdateParameters>
                                                        ...
                                                        <table id="tblSearch" border="0" cellpadding="0" cellspacing="0" height="150" style="display: inline;
                                                            ...
                                                            <tr>
                                                                <td height="28" style="font-weight: bold; font-size: 12px; background-image: url(images/bg_CellNormal_black.jpg);
                                                                    ...
                                                                    &nbsp;New IP Status Type<span id="edit" style="display: none;">&nbsp;<asp:Label ID="lblEditCaption"
