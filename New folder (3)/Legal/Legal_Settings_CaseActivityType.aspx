<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Legal_Settings_CaseActivityType.aspx.vb" Theme="Default"Inherits="admin_Legal_Settings" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;"
                ...
                <tr class="UnderlinedRow">
                    <td class="PageMainHeading" style="height: 31px">
                        Settings<asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true">
                        </asp:ScriptManager>
                    </td>
                </tr>
                <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" height="100%" style="width: 100%;"
                            ...
                            <tr>
                                <td style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px; padding-top: 5px;
                                    ...
                                    <strong>Case Activity Types&nbsp; </strong>
                                    <img src="images/spacer.gif" height="15" width="1" align="absmiddle" style="background-color: #82BDE9">&nbsp;
                                    <input id="btnNewIP" class="btnExtraSimple" onclick="ShowAddNewType();" style="width: 88px"
                                        type="button" value="Add New" /><a href="#" onclick="ShowAddNewType();"></a></td>
                            </tr>
                            <tr>
                                <td colspan="4" style="width: 100%; background-color: white;" valign="top">
                                    <div style="overflow-y: auto; height: 100%; background-color: white">
                                        <asp:UpdatePanel ID="UPTypes" runat="server" UpdateMode="Always">
                                            <ContentTemplate>
                                                <asp:GridView ID="gridCaseStatusType" runat="server" AutoGenerateColumns="False"
                                                    DataKeyNames="ID" SkinID="GridViewNoPaging" DataSourceID="odsCaseActivityType" OnRowCommand="gridCaseStatusType_RowCommand"
                                                    OnRowDataBound="gridCaseStatusType_RowDataBound" AllowPaging="false" Width="100%">
                                                    <EmptyDataTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Name">
                                                            <EditItemTemplate>
                                                                ...
                                                                <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvCaseStatusType" runat="server"
                                                                    ControlToValidate="txtCaseStatusType" CssClass="RequiredField" ErrorMessage="Name is required."></asp:RequiredFieldValidator>
                                                            </EditItemTemplate>
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField ShowHeader="False">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" CommandArgument='<%#Eval("ID")%>'
                                                                    CommandName="Delete" OnClientClick="javascript:event.cancelBubble=true;return confirm('Are you sure you want to delete this Case Activity Type?');"
                                                                    Text="Delete"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:ObjectDataSource ID="odsCaseActivityType" runat="server" DeleteMethod="DeleteCaseActivityType"
                                                    SelectMethod="GetCaseActivityTypes" TypeName="CaseMgmt" UpdateMethod="UpdateCaseActivityType">
                                                    <UpdateParameters>
                                                        ...
                                                        <table id="tblSearch" border="0" cellpadding="0" cellspacing="0" height="150" style="display: inline;
                                                            ...
                                                            <tr>
                                                                <td height="28" style="font-weight: bold; font-size: 12px; background-image: url(images/bg_CellNormal_black.jpg);
                                                                    ...
                                                                    &nbsp;New Case Activity Type<span id="edit" style="display: none;">&nbsp;<asp:Label
                                                                ...
                                                                <td align="right" style="padding-right: 2px; font-weight: bold; font-size: 12px;
                                                                    ...
                                                                    <img onclick="setWindowedControlsVisibility(window,'visible');HideAddNewType();"
                                                                        src="../images/closebox2.gif" align="absmiddle" /></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr class="HeaderRowGreen">
                                                                <td align="center" colspan="2" height="31">
                                                                    ...
                                                                    <input id="Close" class="btn" name="Close" onclick="setWindowedControlsVisibility(window,'visible');HideAddNewType();"
                                        ...
                                        <asp:UpdateProgress ID="Progress1" runat="server" AssociatedUpdatePanelID="UPAdd">
                                            <ProgressTemplate>
                                        ...
                                        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UPTypes">
                                            <ProgressTemplate>
                                                <div class="ProgressIndicatorDIV">
                                                    <br />
                                                    <asp:Image ID="Image3" runat="server" ImageAlign="AbsMiddle" ImageUrl="images/indicator.gif" />
                                                    <span style="font-size: 14px; color: #4b92c1"><b>&nbsp; Loading ...</b></span>
                                                    <br />
                                                    <br />
                                                </div>
