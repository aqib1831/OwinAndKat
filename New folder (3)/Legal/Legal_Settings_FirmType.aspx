<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Legal_Settings_FirmType.aspx.vb" Inherits="admin_Legal_Settings" Theme="Default" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" height="242" style="width: 100%;
                            ...
                            <tr>
                                <td height="29" style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px;
                                    ...
                                    <strong>Firm/Vendor Types&nbsp; </strong>
                                ...
                                <td colspan="3" style="width: 100%" valign="top">
                                    <div style="overflow-y: auto; height: 100%; background-color: white">
                                        <asp:UpdatePanel ID="UPTypes" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="gridFirmType" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                                    DataSourceID="odsFirmType" OnRowCommand="gridIPType_RowCommand" OnRowDataBound="gridIPType_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Name">
                                                            <EditItemTemplate>
                                                                <asp:TextBox ID="txtIPType" runat="server" MaxLength="25" Text='<%# Bind("Name") %>'></asp:TextBox><asp:RequiredFieldValidator
                                                                    SetFocusOnError="true" ID="rfvIPType" runat="server" ControlToValidate="txtIPType"
                                                                    CssClass="RequiredField" Display="Static" ErrorMessage="Name is required."></asp:RequiredFieldValidator></EditItemTemplate>
                                                            <ItemStyle Width="78%" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label1" runat="server" Text='<%# Server.HtmlEncode(Eval("Name")) %>'></asp:Label></ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField ShowHeader="False">
                                                            <ItemTemplate>
                                                                <a>Edit</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" CommandArgument='<%#Eval("ID")%>'
                                                                    CommandName="Delete" OnClientClick="javascript:event.cancelBubble=true;return confirm('Are you sure you want to delete this Firm Type?');"
                                                                    Text="Delete"></asp:LinkButton></ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:ObjectDataSource ID="odsFirmType" runat="server" DeleteMethod="DeleteFirmType"
                                                    SelectMethod="GetAllFirmTypes" TypeName="Firm" UpdateMethod="UpdateFirmType">
                                                    <UpdateParameters>
                                                        ...
                                                        <table id="tblSearch" border="0" cellpadding="0" cellspacing="0" height="150" style="display: inline;
                                                            ...
                                                            <tr>
                                                                <td height="28" style="font-weight: bold; font-size: 12px; background-image: url(images/bg_CellNormal_black.jpg);
                                                                    ...
                                                                    &nbsp;New Firm Type<span id="edit" style="display: none;">&nbsp;<asp:Label ID="lblEditCaption"
                                                            ...
                                                            <tr class="HeaderRowGreen">
                                                                <td align="center" colspan="2" height="31">
                                                                    <asp:Button ID="Save" runat="server" CssClass="btn" Style="width: 50px; height: 20px"
                                                                        Text="Save" ValidationGroup="newType" OnClientClick="document.getElementById(&quot;lblMsg&quot;).style.display='none';" />&nbsp;<input
                                                                            id="Close" class="btn" name="Close" onclick="setWindowedControlsVisibility(window,'visible');HideAddNewType();"
