<%@ Page Language="VB" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Legal_IP_Edit.aspx.vb" Inherits="admin_Legal_NewLegal" validateRequest="false" %>
...
<head id="Head1" runat="server">
   ...
   function AttachHide()
	...
	if(name!=""&&type>0&&address!=""&&phone!=""&&state>0&&country>0&&city!=""&&zip!="")
	{
...
<body style="margin: 0px 0px 0px 0px; height: 100%; width: 100%; overflow: hidden;" onload="onLoad();">
                ...
                <tr style="display: inline" id="LegalTR">
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;"
                            class="MainTable">
                            <tr class="HeaderRowGreen" style="height: 31px; background-image:url('images/bg_cellNormal_black.jpg'); border-bottom:0px;">
                                <td style="font-weight: bold; width: 50%; font-family: Helvetica; height: 31px;">
                                    <asp:Label ID="lblHeading" runat="server" Font-Names="Helvetica" font-weight="bold"
                                        Text="Edit Intellectual Property" ForeColor="white"></asp:Label></td>
                            ...
                            <tr>
                                <td align="center" colspan="2" style="padding-right: 0px; padding-left: 0px; background-color: #daf5d6"
                                    valign="top">
                                    <div style="overflow: auto; height: 100%;" align="center">
                                                            ...
                                                            <td align="center" colspan="2" height="31">
                                                                <asp:Button ID="Save" runat="server" CssClass="btn" OnClick="Save_Click" OnClientClick="document.getElementById('lblMsgStatus').style.display='none';"
                                                                    Style="width: 50px; height: 20px" Text="Save" ValidationGroup="newTypeStatus"
                                                                     />
                                                                <%--<asp:LinkButton ID="Cancel" ValidationGroup="newTypeStatus"  runat="server" style="width: 50px; height: 20px" Text="Close" CssClass="btn"></asp:LinkButton>--%>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%; text-align: left">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="tableInfo">
                                                        <tr id="tr1">
                                                            ...
                                                            <td colspan="2" style="; border-bottom:solid 1px #BADCFC; padding-top:5px; padding-bottom:5px;">
                                                                ...
                                                                Width="240" ValidationGroup="ip"></asp:TextBox> 
                                                        ...
                                                        <tr style="display: inline" id="TRRegNo">
                                                            ...
                                                            <td style="padding-top:5px;  ">
                                                                ...
                                                                Width="160" ValidationGroup="ip"></asp:TextBox>
                                                        ...
                                                        <tr style="display: inline;" id="TRSNo">
                                                            ...
                                                            <td>
                                                                ...
                                                                Width="160" ValidationGroup="ip"></asp:TextBox><br />
                                                        ...
                                                        <tr id="trDept">
                                                            ...
                                                            <td>
                                                                <asp:UpdatePanel ID="UPIPType" runat="server" RenderMode="Inline">
                                                                    ...
                                                                    <ContentTemplate>
                                                                        <asp:DropDownList ID="ddlType" runat="server" CssClass="MediumFontInput" Width="160"
                                                                  ...
                                                                  <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvType" runat="server" ControlToValidate="ddlType"
                                                                    ErrorMessage="Type is Required." InitialValue="-1" Display="None" CssClass="RequiredField"
                                                                        ValidationGroup="ip"></asp:RequiredFieldValidator>
                                                                   <a href="#" onclick="ShowAddNewType();" style="font-size: 7pt; display:none;">[New Type]</a>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Owner:</td>
                                                            <td>
                                                                 <asp:DropDownList ID="ddlOwner" runat="server" CssClass="MediumFontInput" Width="160"
                                                                ...
                                                                <asp:RequiredFieldValidator SetFocusOnError="true" ID="RFV_ddlOwner" runat="server" ControlToValidate="ddlOwner"
                                                            ...
                                                            <td>
                                                                 <span>
                                                                    <asp:DropDownList ID="ddlAssignedTo" runat="server" DataSourceID="ComplianceAdminsDS"
                                                                        DataTextField="Name" DataValueField="ID" Width="160"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:UpdatePanel ID="UPStatus" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:DropDownList ID="ddlStatus" runat="server" CssClass="MediumFontInput" Width="160"
                                                ...
                                                <td style="width:33%; border:solid 2px #6C9BBC; border-right:0px;" valign="top">
                                                     <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="tableInfo">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtExpiresOn" runat="server" CssClass="MediumGreenTextBox" ValidationGroup="ip"
                                                                Width="100%" onfocus="setActiveStyleSheet(this, 'calstyle'); return showCalendar('txtExpiresOn', 'MM/dd/y');"></asp:TextBox>   
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtFirstUsed" runat="server" CssClass="MediumGreenTextBox" Width="100%"
                                                                 ...
                                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                                    ...
                                                                    ValidationGroup="ip" Width="168px"></asp:RequiredFieldValidator>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ReadOnly="True"></asp:TextBox>
                                                                <asp:CustomValidator SetFocusOnError="true" ID="cvValidateAppliedDate" runat="server"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                               <asp:TextBox ID="txtCreationDate" runat="server" CssClass="MediumGreenTextBox" Width="100%"
                                                                    ...
                                                                    ReadOnly="True"></asp:TextBox>
                                                                <asp:CustomValidator SetFocusOnError="true" ID="cv_CreationDate" runat="server" ClientValidationFunction="chkCreationDate"
                                                     ...
                                                     <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="tableInfo">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:70%; padding-top:5px;">
                                                                 ...
                                                                 <asp:CustomValidator SetFocusOnError="true" ID="rfvContact" Display="None" ClientValidationFunction="ValidateFirmContact"
                                                        ...
                                                        <tr>
                                                            <td style="width:10px;">&nbsp;</td>
                                                            <td colspan="2" style="padding-right:5px; padding-left:5px;">
                                                                <asp:DropDownList ID="ddlNotify" runat="server" CssClass="MediumFontInput" Width="100%">
                                            ...
                                            <tr style="height:100%;">
                                                <td style="width:100%; height:100%; border:solid 3px #6C9BBC; border-top:solid 1px #6C9BBC; padding-bottom:0px;" colspan="3">
                                                       <asp:TextBox 
                                                        ID="txtNotes" 
                                                        runat="server" 
                                            ...
                                            <tr>
                                                <td align="left" style="padding-left: 5px; width: 25%; height: 10px">
                                                </td>
                            ...
                            <tr class="FooterRowGreen">
                                <td align="center" colspan="2" style="padding-right: 31px; height: 31px">
                                    <asp:Button ID="BtnSave" runat="server" CssClass="btnGreen" Style="width: 80px" Text="Save" OnClientClick="javascript:if(Validate()== false) return false;"
                                        ValidationGroup="ip" />&nbsp;
                                        <input type="button" id="btnCancel" class="btnGreen" value="Cancel" style="width: 80px" onclick="window.location='Legal_IP.aspx? <%= Request.QueryString().ToString() %> '" />
                                </td>
                            </tr>
                        </table>
