<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Legal_Settings_IPType.aspx.vb" Inherits="admin_Legal_Settings" Theme="Default" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;"
                ...
                <tr>
                    <td style="width: 100%;" valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" height="242" style="width: 100%;
                            height: 100%" width="100%">
                            <tr>
                                <td height="29" style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px;
                                    width: 20%; padding-top: 5px; border-bottom: #609bd3 1px solid; height: 15px">
                                    <strong>Intellectual Property Types&nbsp; </strong>
                                    <img src="../images/spacer.gif" height="15" width="1" align="absmiddle" style="background-color: #82BDE9">&nbsp;
                                    <input id="btnNewIP" class="btnExtraSimple" onclick="ShowAddNewType();document.getElementById('hdnEdit').value=false;" style="width: 88px"
                                        type="button" value="Add New" /></td>
                            </tr>
                            <tr>
                                <td colspan="3" style="width: 100%" valign="top">
                                    <div style="overflow-y: auto; height: 100%; background-color: white">
                                        <asp:UpdatePanel ID="UPTypes" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="gridIPType" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                                    DataSourceID="odsIPType" Width="100%" OnRowCommand="gridIPType_RowCommand" OnRowDataBound="gridIPType_RowDataBound"
                                                    AllowPaging="false" SkinID="GridViewNoPaging" >
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Name">
                                                            <EditItemTemplate>
                                                                <asp:TextBox ID="txtIPType" runat="server" MaxLength="25" Text='<%# Bind("Name") %>'></asp:TextBox>
                                                                <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvIPType" runat="server"
                                                                    ControlToValidate="txtIPType" CssClass="RequiredField" Display="Static" ErrorMessage="Name is required."></asp:RequiredFieldValidator>
                                                            </EditItemTemplate>
                                                            <ItemStyle Width="78%" />
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField ShowHeader="False">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" CommandArgument='<%#Eval("ID")%>'
                                                                    CommandName="Delete" OnClientClick="javascript:event.cancelBubble=true;return confirm('Are you sure you want to delete this IP Type?');"
                                                                    Text="Delete"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:ObjectDataSource ID="odsIPType" runat="server" DeleteMethod="DeleteIPType" SelectMethod="GetIPTypes"
                                                    TypeName="IntellectualProperty" UpdateMethod="UpdateIPType">
                                                    <UpdateParameters>
                                                        ...
                                                        <table id="tblSearch" border="0" cellpadding="0" cellspacing="0" height="150" style="display: inline;
                                                            ...
                                                            <tr>
                                                                <td height="28" style="font-weight: bold; font-size: 12px; background-image: url(images/bg_CellNormal_black.jpg);
                                                                    ...
                                                                    &nbsp;New IP Type<span id="edit" style="display: none;">&nbsp;<asp:Label ID="lblEditCaption"
                                                            ...
                                                            <tr class="HeaderRowGreen">
                                                                <td align="center" colspan="2" height="31">
                                                                    <asp:Button ID="Save" runat="server" CssClass="btn" Style="width: 50px; height: 20px" Text="Save" ValidationGroup="newType" OnClientClick="document.getElementById(&quot;lblMsg&quot;).style.display='none';" />
                                                                    <input id="Close" class="btn" name="Close" onclick="HideAddNewType();" style="width: 50px; height: 20px" type="button" value="Close" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ContentTemplate>
