<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Legal_Settings_CaseType.aspx.vb" Inherits="admin_Legal_Settings" Theme="Default" %>
...
<body scroll="no" style="margin: 0px; width: 100%; height: 100%;" onload="parent.onTRSubClick(parent.subTR1);">
                                ...
                                <td style="width: 100%;" colspan="3" valign="top">
                                    <div style="height: 100%; overflow-y: auto; background-color: white;">
                                        <asp:UpdatePanel ID="UPTypes" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="gridCaseType" runat="server" AutoGenerateColumns="False" DataSourceID="odsCaseType"
                                                    DataKeyNames="ID" Width="100%" OnRowCommand="gridCaseType_RowCommand" OnRowDataBound="gridCaseType_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Name">
                                                            <EditItemTemplate>
                                                                <asp:TextBox MaxLength="25" ID="txtCaseTypeEdit" runat="server" Text='<%# Bind("Name") %>'></asp:TextBox>
                                                                <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvCaseTypes" runat="server"
                                                                    ControlToValidate="txtCaseTypeEdit" CssClass="RequiredField" Display="Static"
                                                        ...
                                                        <asp:TemplateField ShowHeader="False">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" CommandName="Delete"
                                                                    CommandArgument='<%#Eval("ID")%>' Text="Delete" OnClientClick="javascript:event.cancelBubble=true;return confirm('Are you sure you want to delete this Case Type?');"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:ObjectDataSource ID="odsCaseType" runat="server" SelectMethod="GetCaseTypes"
                                                    TypeName="CaseMgmt" UpdateMethod="UpdateCaseTypes" DeleteMethod="DeleteCaseType">
                                                    <UpdateParameters>
                    ...
                    <table id="tblSearch" border="0" cellpadding="0" cellspacing="0" height="150" style="display: inline;
                        ...
                        <tr>
                            <td height="28" style="font-weight: bold; font-size: 12px; background-image: url(images/bg_CellNormal_black.jpg);
                                ...
                                &nbsp;New Case Type<span id="edit" style="display: none;">&nbsp;<asp:Label ID="lblEditCaption"
...
<script language="javascript" type="text/javascript">
    function SetFocus()
    {
        ...
        document.getElementById('<%= txtNewTypeName.ClientID %>').focus();
    }
</script>