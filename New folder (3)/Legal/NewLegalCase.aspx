<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NewLegalCase.aspx.vb" Inherits="admin_Legal_NewLegalCase" Theme="Default" validateRequest="false" %>
...
//    function BindFirms()
//    {
//    alert(document.getElementById("btnBinder").id);
//    document.getElementById("FirmTR").style.display='none';
//    document.getElementById("LegalTR").style.display='inline';
//    document.getElementById("btnBinder").click();
////    document.getElementById("ddlFirm").value=FirmID;
////    document.getElementById("ddlContact").value=ContactID;
//    }
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;"
                                        ...
                                        <div style="height: 100%;" align="center" class="divscroll">
                                            ...
                                            <div style="overflow: auto; height: 100%;">
                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 550px; height: 100%;
                                                    ...
                                                    <tr id="TRSNo">
                                                        <td align="left" style="padding-left: 5px; height: 22px">
                                                            Docket No:<span id="st1" class="RequiredField">*</span>                                                             
                                                        </td>
                                                        <td>
                                                     ...
                                                     <tr height="1">
                                                        ...
                                                        <td>
                                                           ...
                                                           <asp:RangeValidator ID="rngSerial" Display="Dynamic" MinimumValue="0" MaximumValue="999999999" ErrorMessage="Please! Enter Valid Docket Number." CssClass="RequiredField"></asp:RangeValidator>
                                                                </td>
                                                    </tr>
                                                    <tr id="TRRegNo">
                                                        <td align="left" style="padding-left: 5px; height: 22px">
                                                            Firm Case No:<span id="st2" class="RequiredField">*</span></td>
                                                        <td>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 88px; height: 22px">
                                                                        <asp:TextBox ID="txtDateEntered" runat="server" CssClass="MediumGreenTextBox" ReadOnly="True"
                                                                            Width="120px" TabIndex="11" onfocus="this.blur();"></asp:TextBox></td>
                                                                    ...
                                                                    <td colspan="2" style="height: 22px">
                                                                        <asp:TextBox ID="txtCaseDate" runat="server" CssClass="MediumGreenTextBox" ReadOnly="True"
                                                                            Width="120" onfocus="setActiveStyleSheet(this, 'calstyle');return showCalendar('txtCaseDate', 'MM/dd/y');"
                                                                            TabIndex="12"></asp:TextBox>&nbsp;<img src="../images/ico_calendar.jpg" width="24" height="20" align="absmiddle" onclick="setActiveStyleSheet(this, 'calstyle'); return showCalendar('txtCaseDate', 'MM/dd/yyyy');"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ReadOnly="true" ID="txtNotify" 
                                                                            runat="server" TabIndex="13" CssClass="MediumGreenTextBox" Width="120" onfocus="setActiveStyleSheet(this, 'calstyle');return showCalendar('txtNotify', 'MM/dd/y');"></asp:TextBox>
                                                                    </td>
                                                                    <td valign="top">
                                                                     &nbsp;<img src="../images/ico_calendar.jpg" width="24" height="20" align="absmiddle" onclick="setActiveStyleSheet(this, 'calstyle'); return showCalendar('txtNotify', 'MM/dd/yyyy');"
                                                                        style="cursor: pointer;">
                                                                        <asp:RequiredFieldValidator ID="reqDate" runat="server" Display="Dynamic" CssClass="RequiredField" ControlToValidate="txtNotify" ErrorMessage="Notify date is required."></asp:RequiredFieldValidator>
                                                                        <asp:CompareValidator  ID="cmpDate" runat="server" Display="Dynamic" ControlToValidate="txtNotify"
                                                                        ControlToCompare="hdnCurrentDate" Operator="GreaterThanEqual"   ErrorMessage="Date must be in future."
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top">
                                                            <asp:TextBox ID="txtNotes" runat="server" CssClass="MediumGreenTextBox" Height="98%"
                                                                TextMode="MultiLine" Width="380px" MaxLength="2000" TabIndex="14"></asp:TextBox></td>
                                                    </tr>
                                                    <tr height="5px;">
                                ...
                                <tr class="FooterRowGreen">
                                    <td align="center" colspan="2" style="padding-right: 31px; height: 31px">
                                        <asp:Button ID="BtnSave" runat="server" CssClass="btnGreen" Style="width: 80px" Text="Save" TabIndex="15" />&nbsp;
                                        <input id="btnCan" type="button" tabindex="16" value="Cancel" class="btnGreen" onclick="parent.frameMain.location='Legal_Case.aspx'"
                                            style="width: 80px" />
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <div style="overflow-y: auto; height:100%; width: 100%;">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="FranchiseSearchDS">
                                                    <ItemTemplate>
                                                        <tr style="font-size: 11px; vertical-align: top; font-family: Arial, Helvetica, Sans-Serif;
                                                            padding-left: 0.5em; border-bottom: 2px inset #E5F1FB; cursor: pointer; height: 20px;
                                                            padding-right: 0px;" onclick="setWindowedControlsVisibility(window,'visible');setFranchisee('<%#Container.DataItem("ID")%>','<%#Container.DataItem("Store")%>');document.getElementById('ddlType').focus();"
                                                    ...
                                                    <FooterTemplate>
                                                        <tr style="height: 100%; border: solid 1px black;">
                                                            <td height="0" style="display: none; background: green;">
                                                                &nbsp;</td>
                                                        </tr>
