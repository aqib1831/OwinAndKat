<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Legal_Firm_Edit.aspx.vb" Inherits="admin_Legal_Legal_Firm_Edit" validateRequest="false" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;"
                ...
                <tr class="HeaderRowGreen" style="height: 31px;">
                    <td style="font-weight: bold; width: 50%; font-family: Helvetica; height: 31px;">
                        <asp:Label ID="lblHeading" runat="server" Font-Names="Helvetica" font-weight="bold"
                            Text="Edit Firm/Vendor"></asp:Label></td>
                ...
                <tr>
                    <td align="center" colspan="2" style="padding-right: 2px; padding-left: 2px; background-color: #daf5d6">
                        <div style="overflow: auto; height: 100%;">
                            ...
                            <td style="font-size: 9pt; color: #000000; height: 20px">
                                <asp:TextBox ID="txtFirmTitle" runat="server" CssClass="MediumGreenTextBox" MaxLength="40"
                                    Width="350px"></asp:TextBox><br />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFirmTitle"
                                ...
                                <tr style="height: 20px;">
                                    ...
                                    <td colspan="3">
                                        <asp:DropDownList ID="ddlFirmType" CssClass="MediumFontInput" runat="server" Width="350">
                                            <asp:ListItem Value="0">Choose</asp:ListItem>
                                            <asp:ListItem Value="1">Law Firm</asp:ListItem>
                                            <asp:ListItem Value="2">Investigator</asp:ListItem>
                                ...
                                <tr style="height: 1px;">
                                    ...
                                    <td colspan="3">
                                        <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvType" Display="Dynamic"
                                            runat="server" ControlToValidate="ddlFirmType" CssClass="RequiredField" ErrorMessage="Choose firm type"
                                ...
                                <tr style="height: 1px;">
                                    ...
                                    <td colspan="3">
                                        ...
                                        </asp:CustomValidator><asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvAddress"
                                            runat="server" ControlToValidate="txtAddress" CssClass="RequiredField" Display="Dynamic"
                                        ...
                                        <asp:UpdatePanel ID="UPStates" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddlStates" runat="server" CssClass="MediumFontInput" DataSourceID="StatesDS"
                                                    DataTextField="Name" DataValueField="ID" Style="width: 112px">
                                                </asp:DropDownList><asp:SqlDataSource ID="StatesDS" runat="server" ConnectionString="<%$ ConnectionStrings:FSConnectionString %>"
                                ...
                                <tr style="height: 20px;">
                                    ...
                                    <td>
                                        ...
                                        </asp:DropDownList><asp:SqlDataSource ID="CountryDS" runat="server" ConnectionString="<%$ ConnectionStrings:FSConnectionString %>"
                                ...
                                <tr style="height: 1px;">
                                    ...
                                    <td style="width: 30%">
                                        <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvZipCode" runat="server"
                                            ControlToValidate="txtZipCode" CssClass="RequiredField" Display="Dynamic" ErrorMessage="Zip code is required.">
                                        </asp:RequiredFieldValidator></td>
                                    <td style="width: 20%">
                                    </td>
                                    <td style="width: 30%">
                                        <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvCountry" runat="server"
                                            ControlToValidate="ddlCountry" CssClass="RequiredField" Display="Dynamic" ErrorMessage="Country is required."
                                            InitialValue="-1">
                                        </asp:RequiredFieldValidator></td>
                                </tr>
                                <tr style="height: 20px;">
                                ...
                                <tr style="height: 1px;">
                                    ...
                                    <td style="width: 30%">
                                        <asp:RequiredFieldValidator SetFocusOnError="true" ID="RequiredFieldValidator2" runat="server"
                                            ControlToValidate="txtPhone" CssClass="RequiredField" Display="Dynamic" ErrorMessage="Phone No. is required.">
                                        </asp:RequiredFieldValidator></td>
                                    <td style="width: 20%">
                                    </td>
                                    <td style="width: 30%">
                                ...
                                <tr style="height: 1px">
                                    ...
                                    <td colspan="3">
                                        <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvContactName" runat="server"
                                            ControlToValidate="txtContactName" CssClass="RequiredField" Display="Dynamic"
                                ...
                                <tr style="height: 1px;">
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvContactPhone" runat="server"
                                            ControlToValidate="txtContactPhone" CssClass="RequiredField" Display="Dynamic"
                                ...
                                <tr style="height: 1px;">
                                    ...
                                    <td style="width: 31%">
                                        <asp:RegularExpressionValidator SetFocusOnError="true" ID="rfvEmail" runat="server"
                                            CssClass="requiredfield" Display="Dynamic" ControlToValidate="txtContactEmail"
                ...
                <tr class="FooterRowGreen">
                    <td align="center" colspan="2" style="padding-right: 31px; height: 31px">
                        <asp:Button ID="btnFirmSave" runat="server" CssClass="btnGreen" Style="width: 80px"
                            Text="Save" Width="60px" />&nbsp;
                        <asp:Button runat="server" ID="BtnCancel" Text="Cancel" CssClass="btnGreen" Style="width: 80px" />
                    </td>
                </tr>
            </table>
        </div>
