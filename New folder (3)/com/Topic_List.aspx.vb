...
Partial Class com_Topic_List
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        objTopic.Topic = Me.txtTopic.Text.Trim
        result = objTopic.Add()
        If result = 0 Then
    ...
    Protected Sub gvTopic_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvTopic.RowCreated
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim IsFixed As Boolean = CType(DataBinder.Eval(e.Row.DataItem, "IsFixed"), Boolean)
            If IsFixed = True Then
                CType(e.Row.Cells(3).FindControl("lnkEdit"), LinkButton).Visible = False
                e.Row.Cells(3).ToolTip = "This Topic is not allowed to be edited!"
            End If
        End If
    End Sub
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        objTopic.Topic = Me.txtTopicUpdate.Text.Trim
