Partial Class HR_EmployeeTimeHistoryInDetail_Printable
    ...
    Protected Sub rptAttendence_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        ...
        ElseIf e.Item.ItemType = ListItemType.Footer Then
            ...
            CType(e.Item.FindControl("ltrlTotalFlags"), Literal).Text = "LA = " & TotalLateArrivals.ToString() & ", ED = " & TotalEarlyDepartures.ToString() & ", LS = " & TotalLateSittings.ToString()
        End If
    End Sub
            ...
            If e.Item.DataItem("PunchInTime") Is DBNull.Value = False Then
                ...
                If e.Item.DataItem("LateArrivalNotes") Is DBNull.Value = False Then
                    If Not String.IsNullOrEmpty(e.Item.DataItem("LateArrivalNotes")) Then
                        ...
                        CType(e.Item.FindControl("ltrlPunchIn"), Literal).Text = CType(e.Item.FindControl("ltrlPunchIn"), Literal).Text & "<sup style='font-size:8px;font-weight:bold;'>" & CommentIndex.ToString() & "</sup>"
                        StrComments = StrComments & "<sup style='font-size:8px;font-weight:bold;'>" & CommentIndex.ToString() & "</sup>" & e.Item.DataItem("LateArrivalNotes").ToString().Replace(vbCrLf, " ") & "&nbsp;"
                ...
                If e.Item.DataItem("EarlyDepartureNotes") Is DBNull.Value = False Then
                    If Not String.IsNullOrEmpty(e.Item.DataItem("EarlyDepartureNotes")) Then
                        PunchOutCommentIndex = PunchOutCommentIndex + 1
                        CType(e.Item.FindControl("ltrlPunchOut"), Literal).Text = CType(e.Item.FindControl("ltrlPunchOut"), Literal).Text & "<sup style='font-size:8px;font-weight:bold;'>" & CommentIndex.ToString() & "</sup>"
                        StrComments = StrComments & "<sup style='font-size:8px;font-weight:bold;'>" & CommentIndex.ToString() & "</sup>" & e.Item.DataItem("EarlyDepartureNotes").ToString().Replace(vbCrLf, " ") & "&nbsp;"
                        CommentIndex = CommentIndex + 1
                    End If
                End If
                If e.Item.DataItem("LateSittingNotes") Is DBNull.Value = False Then
                    If Not String.IsNullOrEmpty(e.Item.DataItem("LateSittingNotes")) Then
                        PunchOutCommentIndex = PunchOutCommentIndex + 1
                        CType(e.Item.FindControl("ltrlPunchOut"), Literal).Text = CType(e.Item.FindControl("ltrlPunchOut"), Literal).Text & "<sup style='font-size:8px;font-weight:bold;'>" & CommentIndex.ToString() & "</sup>"
                        StrComments = StrComments & "<sup style='font-size:8px;font-weight:bold;'>" & CommentIndex.ToString() & "</sup>" & e.Item.DataItem("LateSittingNotes").ToString().Replace(vbCrLf, " ") & "&nbsp;"
                        CommentIndex = CommentIndex + 1
                    End If
                End If
            Else
