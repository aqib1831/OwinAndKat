<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UsersTimeHistoryAddNew.aspx.vb" Inherits="HR_UsersTimeHistoryAddNew" Theme="Default"  %>
...
<div  style="display:none;"> 
   <asp:UpdatePanel ID="upd1" runat="server" UpdateMode="Always" RenderMode="Inline">
    <ContentTemplate>
        ...
        <asp:HiddenField ID="hdnUserSelected" runat="server" />
    </ContentTemplate>
    </asp:UpdatePanel>
</div>
...
//        }
    ...
    {
        if(document.getElementById('<%=hdnUserSelected.ClientID %>').value!='')
        {
            args.IsValid = true;
        }
        else
    ...
    function _checkvalue(sender,args){
        if(combo.GetValue() == '')                                
           args.IsValid = false;
        else 
            args.IsValid = true;
