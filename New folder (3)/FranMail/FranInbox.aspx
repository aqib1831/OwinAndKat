<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FranInbox.aspx.vb" Inherits="FranMail_FranInbox" %>
            ...
            <tr style="background-color:#A0CDEE; padding:3px; font-size:14px;">
                ...
                <asp:Label ID="lblPageTitle" runat="server" Visible="false"></asp:Label>&nbsp;[<asp:Label ID="lblEmailAddress" runat="server" Text=""></asp:Label>]&nbsp;
                    ...
                    <td style="border-bottom:1px solid #609BD3;" align="right">
                        <input type="button" value="Login To Gmail" title="Login To Gmail" onclick="window.open('login_gmail.html');" style="width:100px; height:20px;" class="Btn3D" />
                   </td>
            </tr>
 ...
 var postbackElement;
  ...
  function ShowEmailDetail(EmailID, EmailSeen, Folder)
  {
    if (EmailSeen==1)
    {
        ...
        iframeEmail.location.href = "Franmail_Detail.aspx?Mailbox="+Folder+"&From=Inbox&ID="+EmailID; 
    }
    else
    {
        window.location ="Franmail_Detail.aspx?Mailbox="+Folder+"&ID=" + EmailID; 
    }
  } 
  
  function OpenMailDetailDiv(EmailID, EmailSeen, Folder)
    {       
        IFMailDetail.location = "FranInbox_Detail.aspx?Mailbox="+Folder+"&ID=" + EmailID;
