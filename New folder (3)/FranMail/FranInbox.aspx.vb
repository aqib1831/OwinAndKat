...
Partial Class FranMail_FranInbox
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            '    ClientScript.RegisterClientScriptBlock(Me.GetType(), "SelectTab", "parent.ChangeTrBackground(1);", True)
            'Else
            '    ClientScript.RegisterClientScriptBlock(Me.GetType(), "SelectTab", "parent.ChangeTrBackground(3);", True)
            'End If
            ...
            ElseIf Mailbox = "GmailSentMail" Then
                ...
                Me.lblPageTitle.Text = "Sent Mail"
                InboxType.SelectedValue = "Sent"
            ElseIf Mailbox = "GmailTrash" Then
                hdnMailBox.Value = "[Gmail]/Trash"
                Me.lblPageTitle.Text = "Trash"
            End If


            'Dim db As DBAccess = New DBAccess()
            'Dim dr As SqlDataReader
            'AdminID = CType(Session("AdminID"), Integer)
            'db.AddParameter("@ID", AdminID)
            'dr = db.ExecuteReader("Users_Get_FranMail_Info")
            'While dr.Read
            '    Me.hdnMailHost.Value = dr("FranMail_MailServer")
            '    Me.hdnPopUsername.Value = dr("FranMail_UserName")
            '    Me.hdnPopPassword.Value = Functions.Decryption(dr("FranMail_Password"))
            'End While
            'dr.Close()

            Me.hdnMailHost.Value = "imap.gmail.com"
            Me.hdnPopUsername.Value = "netsolacemail@gmail.com"
            Me.hdnPopPassword.Value = "admin1952"
    ...
    Public Sub GetMessageHeaders()
        ...
        If Trim(LCase(strMailServer)) = "imap.gmail.com" Then
            imap.Port = 993
            imap.Ssl = True
        End If
    ...
    Public Sub DeleteEmail(ByVal EmailID As Integer)
        ...
        If Not hdnMailBox.Value = "Inbox.Deleted Items" Then
    ...
    Protected Sub InboxType_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles InboxType.SelectedIndexChanged
        If InboxType.SelectedValue = "Sent" Then
            Response.Redirect("franinbox.aspx?Mailbox=GmailSentMail")
        Else
            Response.Redirect("franinbox.aspx")
        End If
    End Sub
