<%@ Page Language="VB" AutoEventWireup="false" CodeFile="List_Topics.aspx.vb" Inherits="KB_List_Topics" Theme="Default" EnableTheming="true" ValidateRequest="false" %>
             ...
             <tr class="UnderlinedRow">
                 <td  style="height:20px;background-color:#A0CDEE;font-size:12px;font-weight:bold;padding:5px;width:80%;">
                     <asp:UpdatePanel ID="UPHeaderCount" runat="server" UpdateMode="Always" RenderMode="Inline">
                        <ContentTemplate>
                            &nbsp;
                            <asp:Label ID="lblCategoryName" runat="server" Font-Bold="True"></asp:Label>
                            | <span class="NonBold">
                ...
                <td colspan="2" style="height:40px;background-color:#BADCFC;font-size:11px;">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="white-space:nowrap;">
                    ...
                    <td style="padding-bottom: 2px;padding-left:5px;" valign="bottom" width="10px;" align="center" runat="server"
                            ...
                            <div style="width:90px;display:inline;" class="FlatButton">New Topic</div>
                                </asp:LinkButton>
                            </td>                
                      <td align="left" style="padding-left:5px; padding-right:5px;width:100px; ">
                        <span style="font-size: 7pt; color: #7c8798">Category:</span><br />
                            ...
                            ID="ddlCategories"
                            runat="server" 
                            CssClass="SmallFontInput" Style="width: 200px;"
                            ...
                            <asp:SqlDataSource ID="SDsCategories"
                             ...
                             SelectCommand="KB_Get_Categories" 
                            ...
                            DataKeyNames="ID">
                             <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Category" SortExpression="CategoryName">
                                            <ItemTemplate>
                                                <%#Server.HtmlEncode(Functions.StringTruncate(Container.DataItem("CategoryName"), 30))%>
                                            </ItemTemplate>
                                            <ItemStyle Height="22px" Width="25%" />
                                        </asp:TemplateField>
                                      <asp:BoundField DataField="UpdatedDate" HeaderText="Last Activity" SortExpression="UpdatedDate"
                                            HtmlEncode="False">
                                            <ItemStyle Height="22px" Width="120px" Wrap="False" />
                                        </asp:BoundField>
                                         <asp:TemplateField HeaderText="Added by" SortExpression="Addedby">
                                            <ItemTemplate>
                                                <%#Server.HtmlEncode(Functions.StringTruncate(Functions.IfNull(Container.DataItem("AddedByName"), "-"), 30))%>
                                            </ItemTemplate>
                                            <ItemStyle Height="22px" Width="90px" />
                                        </asp:TemplateField>
                                     <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="Add_Topic.aspx?TopicID={0}"
                             ...
                             <asp:ObjectDataSource
                                ID="sdTopics" runat="server"
                                SelectMethod="GetCategoryTopic"
                                TypeName="Topic" 
