Partial Class LM_LicenseManagementDC
    ...
    Protected Sub odsSBSLicenses_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles odsSBSLicenses.Selected
        If (IsNumeric(e.ReturnValue)) Then
            ...
            ScriptManager.RegisterStartupScript(Me, Me.GetType(), "showcountdigitalCatalog", "parent.showcountdigitalCatalog(" & e.ReturnValue.ToString() & ");", True)
    ...
    Protected Function FilterChecks()
        ...
        'Else
        odsSBSLicenses.SelectMethod = "GetAllNextStepLicenses_LM"
        odsSBSLicenses.SelectCountMethod = "GetAllNextStepLicensesCount_LM"
