Partial Class DMenu_LicenseManagement
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            If (Request.QueryString("PrevPage") <> Nothing And Request.QueryString("PrevPage") = "MyNetsolace") Then
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "ChangeSelected", "parent.SetSelected2(4); document.getElementById('tdnewbtn').style.display='none';", True)
                ddlClient.Enabled = False
            Else
                ClientScript.RegisterClientScriptBlock(Me.GetType, "SelectTab", "parent.SetSelected(4);", True)
            End If
        Else
            FilterChecks()
        End If
    ...
    Protected Sub odsSBSLicenses_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles odsSBSLicenses.Selected
        If (IsNumeric(e.ReturnValue)) Then
            ...
            End If
            ScriptManager.RegisterStartupScript(Me, Me.GetType(), "showDMenuCount", "parent.showDMenuCount(" & e.ReturnValue.ToString() & ");", True)
        End If
    End Sub
    ...
    Function FilterChecks()
        If Functions.IsSuperAdmin(CInt(Session("AdminID"))) Then
            odsSBSLicenses.SelectMethod = "GetAllDMenuLicenses"
            odsSBSLicenses.SelectCountMethod = "GetAllDMenuLicensesCount"
            sdsClients.SelectCommand = "Clients_GetALL"
        Else
            odsSBSLicenses.SelectMethod = "GetAllDMenuLicensesByLMRights"
            odsSBSLicenses.SelectCountMethod = "GetAllDMenuLicensesByLMRightsCount"
