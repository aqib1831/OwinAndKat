<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NewQsLicenses.aspx.vb" Inherits="LM_NewQsLicenses" %>
...
<body onload="SelectProductDropdownList();">
        ...
        <table border="0" cellpadding="0" align="center" cellspacing="0" style="width: 100%; height:100%; border:0px;" class="tblAddFolder pad5px">                  
            ...
            <tr>
                ...
                <td>
                   <asp:DropDownList ID="ddlProducts" style="font-size:11px;" runat="server" Width="200px" onchange="return CheckQuantityField(this);">
                        <asp:ListItem Text="Qs bundle" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Qs additional" Value="2"></asp:ListItem>                        
                   </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="margin:0; padding:1;padding-left:5;">
                   ...
                   <span id="spntxtDynamicIP" style="display:none;"><asp:TextBox ReadOnly="true" ID="txt_DynimicIP" ValidationGroup="vgNewLicense" runat="server" Width="175px" onfocus="imgDDCalander.click();"></asp:TextBox>
            ...
            <tr>
                ...
                <asp:RegularExpressionValidator ID="revProductname" runat="server" ValidationGroup="vgNewLicense"
                        Display="dynamic" ControlToValidate="txtNotes" SetFocusOnError="true" CssClass="RequiredField" ErrorMessage="<br>Please enter valid text"
                        ValidationExpression="^[^<>]*$"></asp:RegularExpressionValidator>
                </td>
            </tr>           
    ...
    <script type="text/javascript" language="javascript">
        ...
        {   var rdoIP0 = document.getElementById('rdoIP_0');
            ...
            //CustomValidator1 cvValidateDynamicIPDate
            if (rdoIP0.checked)
            {
        ...
        {
            if(document.getElementById('<%=ddlProducts.ClientID %>').value==2)
            {
