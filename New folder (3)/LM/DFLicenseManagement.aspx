<%@ Page Language="VB" AutoEventWireup="false" ValidateRequest="false" CodeFile="DFLicenseManagement.aspx.vb" Inherits="LM_DFLicenseManagement" Theme="Default" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>DF License Management</title>
...
<body onclick="CloseNewLicenseDiv();" style="margin:0px;padding:0px;">
  ...
  <tr class="GalleryTitle" style="background-image:url('../images/bg_mainHdr_1.jpg');height:31px;">
    <td>&nbsp;<span class="IdeaTitle">DF License - 
   ...
   <td style="padding-top:3px; background-image:none;">
  ...
  <tr style="height:100%;">
    ...
    <ContentTemplate>    
        <asp:GridView ID="gvwKeys" runat="server" AutoGenerateColumns="False" Width="100%"  SkinID="gvwSilver"
            DataSourceID="odsDFLicenses" AllowPaging="true" AllowSorting="true" Height="100%" ShowFooter="true" EnableViewState="true">
            <Columns>
                ...
                <asp:TemplateField HeaderText="DF Version">
                    <ItemTemplate>
                       <div align="center"><%#Eval("CurrentVersion")%></div>
                    </ItemTemplate>
                    <FooterTemplate>
                        &nbsp;
                    </FooterTemplate>
...
<asp:ObjectDataSource ID="odsDFLicenses" runat="server" TypeName="Portal.BLL.DFLicenseManagement" 
     SelectMethod="GetAllDFLicenses" MaximumRowsParameterName="maximumRows" StartRowIndexParameterName="startRowIndex" 
     SelectCountMethod="GetAllDFLicensesCount" SortParameterName="sortBy" EnablePaging="true" EnableViewState="true">
    <SelectParameters>
...
<asp:SqlDataSource ID="sdsStates" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowNewLicenseDiv(){                        
            ...
            ifNewLicense.location='NewDFLicenses.aspx';
        ...
        function ShowDetail(licenseId){                            
          ...
          window.location='DFLicenseDetails.aspx?LicenseID='+licenseId+'&ddlClient='+ddlClient+'&ddlStates='+ddlStates+'&ddlFilters='+ddlFilters;
        }
        function ShowDetailReadonly(licenseId){
          var ddlClient = document.getElementById('<%= ddlClient.ClientID %>').value; 
          var ddlStates =  document.getElementById('<%= ddlStates.ClientID %>').value; 
          var ddlFilters =  document.getElementById('<%= ddlFilters.ClientID %>').value; 
          window.location='LicenseDetail.aspx?LicenseID='+licenseId+'&ddlClient='+ddlClient+'&ddlStates='+ddlStates+'&ddlFilters='+ddlFilters+'&PrevPage=MyNetsolace';
        }
        function NavigateToPrintVersion()
        {
            ...
            URL = "DFLicensesReport.aspx" + QueryStringValues;
        ...
        function OnXLSDownload()
        {
            ...
            QueryStringValues += "&SortBy=" + document.getElementById('<%=hdnSortBy.ClientID %>').value;  
            QueryStringValues += "&State=" + ddlStates.options[ddlStates.selectedIndex].text;  
            URL = "DFLicensesReport.aspx" + QueryStringValues+'&IsXLS=True'; 
