Partial Class LM_DFLicenseManagement
    ...
    Protected Sub odsDFLicenses_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles odsDFLicenses.Selected
        If (IsNumeric(e.ReturnValue)) Then
            ltrlRecordCount.Text = e.ReturnValue.ToString
            ScriptManager.RegisterStartupScript(Me, Me.GetType(), "ShowDfLicenseCount", "parent.ShowDfLicenseCount(" & e.ReturnValue.ToString() & ");", True)
    ...
    Function FilterChecks()
        If Functions.IsSuperAdmin(CInt(Session("AdminID"))) Then
            odsDFLicenses.SelectMethod = "GetAllDFLicenses"
            odsDFLicenses.SelectCountMethod = "GetAllDFLicensesCount"
            sdsClients.SelectCommand = "Clients_GetALL"
        Else
            odsDFLicenses.SelectMethod = "GetAllDFLicenses_LM"
            odsDFLicenses.SelectCountMethod = "GetAllDFLicensesCount_LM"
            If odsDFLicenses.SelectParameters("UserID") Is Nothing Then
                odsDFLicenses.SelectParameters.Add("UserID", CInt(Session("AdminID")))
            End If
