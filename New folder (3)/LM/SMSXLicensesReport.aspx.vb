...
Partial Class LM_SMSXLicensesReport
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not String.IsNullOrEmpty(Request.QueryString("IsXLS")) AndAlso CBool(Request.QueryString("IsXLS")) Then
            ...
            Response.AddHeader("content-disposition", "attachment; filename=SMSxLicenseReport.xls")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Functions.IsSuperAdmin(CInt(Session("AdminID"))) Then
            odsSMSXLicenses.SelectMethod = "GetAllSMXLicensesForReporting_LM"
            If odsSMSXLicenses.SelectParameters("UserID") Is Nothing Then
                odsSMSXLicenses.SelectParameters.Add("UserID", CInt(Session("AdminID")))
            End If
        End If
    End Sub
